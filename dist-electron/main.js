"use strict";var dn=Object.defineProperty;var mn=(e,n,t)=>n in e?dn(e,n,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[n]=t;var D=(e,n,t)=>mn(e,typeof n!="symbol"?n+"":n,t);const P=require("electron"),un=require("path"),pn=require("fs"),hn=require("os"),Oe=require("child_process"),rt=require("util"),gn=require("http"),fn=require("net"),bn=require("fs/promises"),xn=require("crypto"),wn=require("zlib");function de(e){const n=Object.create(null,{[Symbol.toStringTag]:{value:"Module"}});if(e){for(const t in e)if(t!=="default"){const r=Object.getOwnPropertyDescriptor(e,t);Object.defineProperty(n,t,r.get?r:{enumerable:!0,get:()=>e[t]})}}return n.default=e,Object.freeze(n)}const m=de(un),f=de(pn),L=de(hn),Ut=de(gn),Dt=de(fn),at=de(xn),G=process.env.LOCALAPPDATA||m.join(L.homedir(),"AppData","Local"),bt=process.env.APPDATA||m.join(L.homedir(),"AppData","Roaming"),Q=process.env.ProgramFiles||"C:\\Program Files",qe=process.env["ProgramFiles(x86)"]||"C:\\Program Files (x86)",Ne=[{id:"workbuddy",name:"WorkBuddy",exeNames:["WorkBuddy.exe"],processName:"WorkBuddy.exe",defaultPort:9339,installPaths:[m.join(G,"workbuddy"),m.join(G,"Programs","workbuddy"),m.join(Q,"WorkBuddy"),m.join(qe,"WorkBuddy"),"D:\\Program Files\\WorkBuddy"],rendererHints:["app.asar/renderer/index.html","renderer/index.html","index.html"],kind:"workbuddy"},{id:"codex",name:"Codex",exeNames:["ChatGPT.exe","Codex.exe"],processName:"ChatGPT.exe",defaultPort:9340,installPaths:[m.join(G,"Programs","Codex"),m.join(G,"Programs","OpenAI","Codex"),m.join(Q,"Codex"),m.join(qe,"Codex"),"D:\\Program Files\\Codex"],rendererHints:["index.html","renderer/index.html"],kind:"codex"},{id:"trae-work",name:"TRAE Work",exeNames:["TRAE SOLO CN.exe","TRAE Work CN.exe"],processName:"TRAE SOLO CN.exe",defaultPort:9341,installPaths:["D:\\Program Files\\TRAE SOLO CN",m.join(G,"Programs","TRAE SOLO CN"),m.join(Q,"TRAE SOLO CN")],rendererHints:["solo/solo-lite.html","solo-lite.html"],kind:"vscode-work"},{id:"qoder-work",name:"QoderWork",exeNames:["QoderWork CN.exe","QoderWork.exe"],processName:"QoderWork CN.exe",defaultPort:9342,installPaths:["D:\\Program Files\\QoderWork CN",m.join(G,"Programs","QoderWork CN"),m.join(Q,"QoderWork CN")],rendererHints:["out/renderer/index.html","renderer/index.html"],kind:"generic-work",devToolsActivePort:m.join(bt,"QoderWork CN","DevToolsActivePort")},{id:"catpaw",name:"CatPaw",exeNames:["CatPaw.exe"],processName:"CatPaw.exe",defaultPort:9343,installPaths:[m.join(G,"CatPaw"),m.join(G,"Programs","CatPaw"),m.join(Q,"CatPaw")],rendererHints:["app.asar/dist/index.html","dist/index.html"],kind:"generic-work"},{id:"zcode",name:"ZCode",exeNames:["ZCode.exe"],processName:"ZCode.exe",defaultPort:9344,installPaths:["D:\\Program Files\\ZCode",m.join(G,"Programs","ZCode"),m.join(Q,"ZCode")],rendererHints:["out/renderer/index.html","renderer/index.html"],kind:"generic-work"},{id:"qwen-office",name:"千问办公",exeNames:["QwenWorkCN.exe"],processName:"QwenWorkCN.exe",defaultPort:9345,installPaths:["D:\\Program Files\\QwenWorkCN",m.join(G,"Programs","QwenWorkCN"),m.join(Q,"QwenWorkCN")],rendererHints:["out/renderer/index.html","renderer/index.html"],kind:"generic-work",devToolsActivePort:m.join(bt,"QwenWorkCN","DevToolsActivePort")},{id:"hana-agent",name:"HanaAgent",exeNames:["HanaAgent.exe"],processName:"HanaAgent.exe",defaultPort:9346,installPaths:[m.join(G,"Programs","HanaAgent"),m.join(Q,"HanaAgent"),m.join(qe,"HanaAgent")],rendererHints:[".hanako/artifacts/renderer/","artifacts/renderer/","/index.html"],kind:"generic-work"}];function W(e){return Ne.find(n=>n.id===e)}const Ie=1;function yn(){const e=Be().paths;return Ne.map(n=>{const t=e[n.id];return{appId:n.id,name:n.name,exeNames:[...n.exeNames],customPath:t,customPathStatus:t?ot(n.id,t)?"valid":"invalid":"none"}})}function vn(e){const n=Be().paths[e];return n&&ot(e,n)?n:void 0}function kn(e,n){const t=W(e);if(!t)throw new Error(`Unknown app: ${e}`);if(!ot(e,n))throw new Error(`请选择 ${t.name} 的可执行文件（${t.exeNames.join(" 或 ")}）`);const r=Be();return r.paths[e]=m.resolve(n),Nt(r),r.paths[e]}function Cn(e){if(!W(e))throw new Error(`Unknown app: ${e}`);const n=Be();delete n.paths[e],Nt(n)}function ot(e,n){const t=W(e);if(!t||!n||typeof n!="string")return!1;try{if(!f.statSync(n).isFile())return!1}catch{return!1}const r=m.basename(n).toLowerCase();return t.exeNames.some(a=>a.toLowerCase()===r)}function Ot(){return m.join(P.app.getPath("userData"),"app-paths.json")}function Be(){try{const e=JSON.parse(f.readFileSync(Ot(),"utf8"));if(!e||typeof e!="object"||Array.isArray(e))return Ve();const n=e;if(n.version!==Ie||!n.paths||typeof n.paths!="object"||Array.isArray(n.paths))return Ve();const t={};for(const[r,a]of Object.entries(n.paths))W(r)&&typeof a=="string"&&a.trim()&&(t[r]=a);return{version:Ie,paths:t}}catch{return Ve()}}function Ve(){return{version:Ie,paths:{}}}function Nt(e){const n=Ot();f.mkdirSync(m.dirname(n),{recursive:!0}),f.writeFileSync(n,`${JSON.stringify({version:Ie,paths:e.paths},null,2)}
`,"utf8")}const Sn=rt.promisify(Oe.execFile);async function Bt(e){const n=W(e);if(!n)return null;const t=vn(e);if(t)return t;const r=Tn(n.exeNames,n.installPaths);if(r)return r;const a=$n(n);if(a)return a;if(e==="codex"){const o=En();return o||_n()}return null}function Tn(e,n){for(const t of n)if(!(!t||!f.existsSync(t)))try{if(f.statSync(t).isFile()&&Mn(t,e))return t;for(const a of e){const o=m.join(t,a);if(xe(o))return o}const r=f.readdirSync(t,{withFileTypes:!0}).filter(a=>a.isDirectory()).sort((a,o)=>o.name.localeCompare(a.name,void 0,{numeric:!0}));for(const a of r)for(const o of e){const s=m.join(t,a.name,o);if(xe(s))return s}}catch{}return null}function $n(e){const n=[process.env.ProgramFiles,process.env["ProgramFiles(x86)"]].filter(t=>!!t);for(const t of n)if(f.existsSync(t))try{const r=f.readdirSync(t).find(a=>a.toLowerCase().includes(e.id.replace("-",""))||a.toLowerCase().includes(e.name.toLowerCase()));if(!r)continue;for(const a of e.exeNames){const o=m.join(t,r,a);if(xe(o))return o}}catch{}return null}function En(){const e=m.join(process.env.ProgramFiles||"C:\\Program Files","WindowsApps");if(!f.existsSync(e))return null;try{for(const n of f.readdirSync(e)){if(!/^OpenAI\.Codex_\d+/i.test(n))continue;const t=m.join(e,n,"app","ChatGPT.exe");if(xe(t))return t}}catch{}return null}async function _n(){const e=`
...
`;try{const{stdout:n}=await Sn("powershell.exe",["-NoLogo","-NoProfile","-NonInteractive","-ExecutionPolicy","Bypass","-Command",e],{encoding:"utf8",maxBuffer:4194304}),t=n.trim();return xe(t)?t:null}catch{return null}}function Mn(e,n){const t=m.basename(e).toLowerCase();return n.some(r=>r.toLowerCase()===t)}function xe(e){try{return f.statSync(e).isFile()}catch{return!1}}async function In(){if(L.platform()!=="win32")return[];const e=[];for(const n of Ne){const t=await Bt(n.id);t&&e.push({appId:n.id,name:n.name,path:t})}return e}const xt=rt.promisify(Oe.execFile);async function jt(e){const n=W(e);if(!n)return!1;const t=[...new Set([n.processName,...n.exeNames].filter(Boolean))];if(L.platform()==="win32"){for(const r of t)try{const{stdout:a}=await xt("tasklist.exe",["/FI",`IMAGENAME eq ${r}`,"/FO","CSV","/NH"],{encoding:"utf8",windowsHide:!0});if(a.split(/\r?\n/).some(o=>o.trim().toLowerCase().startsWith(`"${r.toLowerCase()}"`)))return!0}catch{}return!1}for(const r of t)try{return await xt("pgrep",["-f",r],{encoding:"utf8"}),!0}catch{}return!1}async function Lt(e,n){if(!/^[a-z0-9-]+$/i.test(e||""))return{success:!1,error:`Invalid appId: ${e}`};if(n!=null&&!/^[a-z0-9._-]+$/i.test(n))return{success:!1,error:`Invalid themeId: ${n}`};const t=W(e);if(!t)return{success:!1,error:`Unknown app: ${e}`};const r=t.defaultPort,a=[`--remote-debugging-port=${r}`];e==="codex"&&a.push("--disable-extensions"),n&&a.push(`--dream-theme=${n}`);try{const o=await jn(e);if(!o||!f.existsSync(o)||!f.statSync(o).isFile())return{success:!1,error:`Executable not found: ${o}`};if(L.platform()==="win32"&&!/\.exe$/i.test(o))return{success:!1,error:`Refusing to launch non-executable path: ${o}`};if(console.log(`[launcher] Killing existing ${e} instances...`),await Nn(e),await Bn(r,15e3),t.devToolsActivePort)try{f.unlinkSync(t.devToolsActivePort)}catch{}console.log(`[launcher] Launching ${o} with args: ${a.join(" ")}`);const s=Oe.spawn(o,a,{detached:!0,stdio:"ignore",env:Pn()});s.unref(),console.log(`[launcher] Spawned process with PID: ${s.pid}`),console.log(`[launcher] Waiting for CDP port ${r} to be ready...`);let c=r;return t.devToolsActivePort?c=await An(t.devToolsActivePort,t.rendererHints,3e4):await Dn(r,3e4),console.log(`[launcher] CDP port ${c} is ready`),e==="hana-agent"&&await Un(c,t.rendererHints,3e4),{success:!0,port:c}}catch(o){return console.error("[launcher] Launch failed:",o),{success:!1,error:o.message}}}function Pn(){const e={...process.env};for(const n of["VITE_DEV_SERVER_URL","ELECTRON_RENDERER_URL","MAIN_VITE_DEV_SERVER_URL","ELECTRON_RUN_AS_NODE"])delete e[n];return e}async function An(e,n,t){const r=Date.now();let a=0;for(;Date.now()-r<t;){try{const o=f.readFileSync(e,"utf8").split(/\r?\n/,1)[0],s=Number(o);if(Number.isInteger(s)&&s>0)return a=s,await Rn(s,n,3e3),s}catch{}await new Promise(o=>setTimeout(o,500))}throw new Error(`DevToolsActivePort did not expose a live renderer${a?` on port ${a}`:""}: ${e}`)}async function Rn(e,n,t){const r=Date.now();for(;Date.now()-r<t;){try{const a=await fetch(`http://127.0.0.1:${e}/json/list`,{signal:AbortSignal.timeout(1e3)});if(a.ok){const o=await a.json();if(Array.isArray(o)&&o.some(s=>(s==null?void 0:s.type)==="page"&&n.some(c=>String(s.url).includes(c))))return}}catch{}await new Promise(a=>setTimeout(a,250))}throw new Error(`CDP renderer endpoint is not ready on port ${e}`)}async function Un(e,n,t){const r=Date.now();let a="",o=0;for(;Date.now()-r<t;){try{const i=(await(await fetch(`http://127.0.0.1:${e}/json/list`,{signal:AbortSignal.timeout(1e3)})).json()).find(l=>(l==null?void 0:l.type)==="page"&&n.some(d=>String(l.url).includes(d)));if(i!=null&&i.id){if(i.id!==a)a=i.id,o=Date.now();else if(Date.now()-o>=3e3){console.log(`[launcher] Stable HanaAgent renderer ${a} confirmed`);return}}}catch{}await new Promise(s=>setTimeout(s,250))}throw new Error(`HanaAgent renderer did not stabilize on port ${e}`)}async function Dn(e,n){const t=Date.now();let r="unknown";for(;Date.now()-t<n;)try{await new Promise((a,o)=>{const s=Dt.createConnection(e,"127.0.0.1",()=>{s.end(),a()});s.once("error",c=>{r=c.message,o(c)}),setTimeout(()=>{s.destroy(),o(new Error("timeout"))},1e3)}),console.log(`[launcher] Port ${e} is open, verifying CDP endpoint...`),await On(e,15e3),console.log(`[launcher] CDP endpoint verified on port ${e}`);return}catch(a){r=a.message,console.log(`[launcher] Port check failed: ${a.message}, retrying...`),await new Promise(o=>setTimeout(o,1e3))}throw new Error(`CDP port ${e} did not become ready within ${n}ms (last error: ${r})`)}async function On(e,n){const t=Date.now();for(;Date.now()-t<n;)try{await new Promise((r,a)=>{const o=Ut.request({hostname:"127.0.0.1",port:e,path:"/json/version",method:"GET",timeout:2e3},s=>{let c="";s.on("data",i=>{c+=i}),s.on("end",()=>{s.statusCode===200?(console.log(`[launcher] CDP version response: ${c.substring(0,200)}`),r()):a(new Error(`HTTP ${s.statusCode}`))})});o.on("error",a),o.on("timeout",()=>{o.destroy(),a(new Error("timeout"))}),o.end()});return}catch(r){if(Date.now()-t>=n)throw r;await new Promise(a=>setTimeout(a,1e3))}}async function Nn(e){const n=L.platform(),t=W(e);if(!t)return;const r=[...new Set([t.processName,...t.exeNames].filter(Boolean))];try{if(n==="win32"){const{spawnSync:a}=require("child_process");for(const o of r)try{a("taskkill",["/T","/F","/IM",o],{stdio:"ignore"}),console.log(`[launcher] Killed existing ${o} process tree`)}catch{}}else if(n==="darwin"){const{spawnSync:a}=require("child_process");for(const o of r)try{a("pkill",["-f",o],{stdio:"ignore"}),console.log(`[launcher] Killed existing ${o} processes`)}catch{}}else if(n==="linux"){const{spawnSync:a}=require("child_process");for(const o of r)try{a("pkill",["-f",o],{stdio:"ignore"}),console.log(`[launcher] Killed existing ${o} processes`)}catch{}}}catch(a){console.warn("[launcher] Failed to kill existing instances:",a)}}async function Bn(e,n){const t=Date.now();for(;Date.now()-t<n;){if(!await new Promise(a=>{const o=Dt.createConnection(e,"127.0.0.1");o.once("connect",()=>{o.destroy(),a(!0)}),o.once("error",()=>a(!1)),o.setTimeout(500,()=>{o.destroy(),a(!1)})})){console.log(`[launcher] Previous CDP port ${e} is closed`);return}await new Promise(a=>setTimeout(a,250))}throw new Error(`Existing ${e} CDP service did not stop; refusing to inject into the old application instance`)}async function jn(e){if(!W(e))throw new Error(`Unknown app: ${e}`);const t=L.platform();if(t==="win32"){const r=await Bt(e);if(r)return r}else if(t==="darwin"){const r=["/Applications/WorkBuddy.app","/Applications/ChatGPT.app"];for(const a of r)if(f.existsSync(a))return a}else if(t==="linux"){const r=e==="workbuddy"?["workbuddy","WorkBuddy"]:["codex","Codex"],a=["/usr/bin","/usr/local/bin","/opt",m.join(L.homedir(),".local","bin"),"/snap/bin"];for(const o of a)if(f.existsSync(o))for(const s of r){const c=m.join(o,s);if(f.existsSync(c))return c}for(const o of r)try{const{spawnSync:s}=require("child_process"),c=s("which",[o],{encoding:"utf8"}),i=String(c.stdout||"").trim();if(i&&f.existsSync(i))return i}catch{}}throw new Error(`Could not find ${e} executable`)}const Ln=5e3,Wn=100,Hn=15e3,Fn=1e4,zn=5e3;function qn(e){if(!Number.isInteger(e)||e<1024||e>65535)throw new TypeError("port must be an integer from 1024 through 65535");return e}function se(e,n,t={}){const r=t.allowZero?0:Number.EPSILON;if(!Number.isFinite(e)||e<r){const a=t.allowZero?"non-negative":"positive";throw new TypeError(`${n} must be a finite ${a} number`)}return e}function Wt(e){if(typeof e!="string"||e.length===0||e!==e.trim())throw new TypeError("webSocketDebuggerUrl must be a non-empty URL string");let n;try{n=new URL(e)}catch(t){throw new TypeError(`webSocketDebuggerUrl is invalid: ${t.message}`)}if(n.protocol!=="ws:"||n.hostname!=="127.0.0.1"||n.username||n.password||n.hash||!n.port)throw new TypeError("webSocketDebuggerUrl must use ws://127.0.0.1 with an explicit port");return qn(Number(n.port)),n}function Vn(e,n){if(e===null||typeof e!="object"||Array.isArray(e)||e.type!=="page"||typeof e.url!="string"||typeof e.webSocketDebuggerUrl!="string")return!1;try{Wt(e.webSocketDebuggerUrl)}catch{return!1}return e.url.includes(n)}function je(e){if(e===null||typeof e!="object"||Array.isArray(e)||e.type!=="page"||typeof e.url!="string"||typeof e.webSocketDebuggerUrl!="string")return!1;try{return Wt(e.webSocketDebuggerUrl),!0}catch{return!1}}function Gn(e){return new Promise(n=>setTimeout(n,e))}async function wt(e,n){const t=Math.max(0,n.deadline-Date.now());let r=null;try{return await Promise.race([e,new Promise((a,o)=>{r=setTimeout(()=>{var s;(s=n.onTimeout)==null||s.call(n),o(new Error(`${n.label} timed out after ${n.timeoutMs}ms`))},t)})])}finally{r&&clearTimeout(r)}}async function me(e,n,t={}){const r=se(t.timeoutMs??zn,"timeoutMs",{allowZero:!1}),a=t.fetchImpl??globalThis.fetch;if(typeof a!="function")throw new TypeError("fetchImpl must be a function");const o=`http://127.0.0.1:${e}/json/list`,s=new AbortController,c=Date.now()+r,i=t.quiet===!0;i||console.log(`[cdp] fetchRendererTargets: port=${e}, timeoutMs=${r}, endpoint=${o}`);let l;try{l=await wt(Promise.resolve(a(o,{redirect:"error",signal:s.signal})),{deadline:c,timeoutMs:r,label:"renderer target discovery",onTimeout:()=>s.abort()})}catch(p){throw i||console.log("[cdp] fetchRendererTargets error:",p),new Error(`failed to fetch renderer targets from ${o}: ${p.message}`)}if(l===null||typeof l!="object"||!l.ok)throw new Error(`renderer target discovery failed with HTTP ${(l==null?void 0:l.status)??"unknown"}`);let d;try{d=await wt(Promise.resolve(l.json()),{deadline:c,timeoutMs:r,label:"renderer target discovery JSON",onTimeout:()=>s.abort()})}catch(p){throw new Error(`malformed renderer target JSON from ${o}: ${p.message}`)}if(!Array.isArray(d))throw new Error("malformed renderer target JSON: expected an array");return d.filter(p=>Vn(p,n)).sort(Kn)}async function Jn(e,n,t={}){const r=se(t.timeoutMs??Ln,"timeoutMs",{allowZero:!0}),a=se(t.pollMs??Wn,"pollMs",{allowZero:!1}),o=t.fetchImpl??globalThis.fetch;let s=0;const c=Date.now()+r;let i=new Error("no renderer discovery attempt completed");for(console.log(`[cdp] waitForRendererTargets: port=${e}, hint=${n}, timeoutMs=${r}`);;){try{const d=Math.max(1,Math.min(r-s,c-Date.now()));console.log(`[cdp] Attempting fetch: elapsed=${s}ms, remainingBudget=${d}ms, deadline=${c}`);const p=await me(e,n,{fetchImpl:o,timeoutMs:d});if(p.length>0)return p;i=new Error("no matching renderer/index.html page targets")}catch(d){i=d instanceof Error?d:new Error(String(d)),console.log("[cdp] Fetch error:",i.message)}if(s>=r||Date.now()>=c)throw new Error(`timed out after ${r}ms waiting for renderer targets on 127.0.0.1:${e}: ${i.message}`);const l=Math.min(a,r-s);await Gn(l),s+=l}}class J{constructor(n,t={}){D(this,"webSocketDebuggerUrl");D(this,"WebSocketImpl");D(this,"commandTimeoutMs");D(this,"connectTimeoutMs");D(this,"socket",null);D(this,"nextRequestId",1);D(this,"pending",new Map);D(this,"socketOpen",!1);D(this,"opened",!1);D(this,"closed",!1);D(this,"closeStarted",!1);D(this,"terminalError",null);D(this,"openPromise",null);D(this,"resolveOpen",null);D(this,"rejectOpen",null);D(this,"connectTimer",null);this.webSocketDebuggerUrl=n;let r=null,a=null;try{r=require("ws")??null,r||(a="ws loaded but WebSocket is undefined")}catch(o){a=`ws require failed: ${(o==null?void 0:o.message)??o}`}if(!r)try{const o=require("undici");r=(o==null?void 0:o.WebSocket)??null,r||(a="undici loaded but WebSocket is undefined")}catch(o){a=`undici require failed: ${(o==null?void 0:o.message)??o}`}if(!r&&typeof globalThis.WebSocket=="function"&&(r=globalThis.WebSocket,a=null),!r){const o=a?` (${a})`:"";throw new Error(`No WebSocket implementation available for CDP${o}`)}this.WebSocketImpl=t.WebSocketImpl??r,this.commandTimeoutMs=se(t.commandTimeoutMs??Hn,"commandTimeoutMs"),this.connectTimeoutMs=se(t.connectTimeoutMs??Fn,"connectTimeoutMs")}open(){if(this.closed)return Promise.reject(this.terminalError??new Error("CDP session is closed"));if(this.opened)return Promise.resolve(this);if(this.openPromise)return this.openPromise;this.openPromise=new Promise((t,r)=>{this.resolveOpen=t,this.rejectOpen=r}),this.connectTimer=setTimeout(()=>{this.terminate(new Error(`CDP WebSocket connect timed out after ${this.connectTimeoutMs}ms`)),this.closeSocket()},this.connectTimeoutMs);try{this.socket=new this.WebSocketImpl(this.webSocketDebuggerUrl)}catch(t){return this.terminate(new Error(`failed to open CDP WebSocket: ${t.message}`)),this.openPromise}const n=this.socket;return n.onopen=()=>{this.closed||this.socketOpen||(this.clearConnectTimer(),this.socketOpen=!0,Promise.all([this.send("Runtime.enable"),this.send("Page.enable")]).then(()=>{if(this.closed)return;this.opened=!0;const t=this.resolveOpen;this.resolveOpen=null,this.rejectOpen=null,t==null||t(this)}).catch(t=>{this.terminate(t),this.closeSocket()}))},n.onmessage=t=>this.handleMessage(t),n.onerror=t=>{const r=t.error,a=r instanceof Error?r.message:typeof t.message=="string"&&t.message.length>0?t.message:"unknown socket error";this.terminate(new Error(`CDP WebSocket error: ${a}`)),this.closeSocket()},n.onclose=()=>{this.closeStarted=!0,this.terminate(new Error("CDP WebSocket closed"))},this.openPromise}send(n,t={},r={}){if(this.closed)return Promise.reject(this.terminalError??new Error("CDP session is closed"));if(!this.socketOpen||!this.socket)return Promise.reject(new Error("CDP session is not open"));if(typeof n!="string"||n.length===0)return Promise.reject(new TypeError("CDP method must be a non-empty string"));const a=se(r.timeoutMs??this.commandTimeoutMs,"timeoutMs"),o=this.nextRequestId++;return new Promise((s,c)=>{const i=setTimeout(()=>{this.pending.delete(o),c(new Error(`CDP ${n} timed out after ${a}ms`))},a);this.pending.set(o,{resolve:s,reject:c,timer:i});try{this.socket.send(JSON.stringify({id:o,method:n,params:t}))}catch(l){clearTimeout(i),this.pending.delete(o),c(new Error(`failed to send CDP ${n}: ${l.message}`))}})}async evaluate(n,t={}){var a,o,s;if(typeof n!="string")throw new TypeError("Runtime.evaluate expression must be a string");const r=await this.send("Runtime.evaluate",{expression:n,awaitPromise:!0,returnByValue:!0},t);if(r!=null&&r.exceptionDetails)throw new Error(`Runtime.evaluate failed: ${((a=r.exceptionDetails.exception)==null?void 0:a.description)??r.exceptionDetails.text??"unknown JavaScript exception"}`);if(((o=r==null?void 0:r.result)==null?void 0:o.type)!=="undefined")return(s=r==null?void 0:r.result)==null?void 0:s.value}async addScriptToEvaluateOnNewDocument(n){const t=await this.send("Page.addScriptToEvaluateOnNewDocument",{source:n});return t==null?void 0:t.identifier}async removeScriptToEvaluateOnNewDocument(n){await this.send("Page.removeScriptToEvaluateOnNewDocument",{identifier:n})}close(){this.closeStarted||(this.terminate(new Error("CDP session closed by client")),this.closeSocket())}handleMessage(n){if(typeof n.data!="string"){this.terminate(new Error("received a non-text CDP WebSocket message")),this.closeSocket();return}let t;try{t=JSON.parse(n.data)}catch(a){this.terminate(new Error(`received malformed CDP JSON: ${a.message}`)),this.closeSocket();return}if(!Number.isInteger(t==null?void 0:t.id))return;const r=this.pending.get(t.id);if(r){if(this.pending.delete(t.id),clearTimeout(r.timer),t.error){r.reject(new Error(`CDP error: ${t.error.message}`));return}r.resolve(t.result)}}terminate(n){if(this.terminalError)return;this.clearConnectTimer(),this.terminalError=n,this.closed=!0,this.socketOpen=!1;const t=this.rejectOpen;this.resolveOpen=null,this.rejectOpen=null,t==null||t(n);for(const{reject:r,timer:a}of this.pending.values())clearTimeout(a),r(n);this.pending.clear()}clearConnectTimer(){this.connectTimer!==null&&(clearTimeout(this.connectTimer),this.connectTimer=null)}closeSocket(){if(this.closeStarted||(this.closeStarted=!0,!this.socket||typeof this.socket.close!="function"))return;const n=this.WebSocketImpl.CLOSING??2,t=this.WebSocketImpl.CLOSED??3;this.socket.readyState===n||this.socket.readyState===t||this.socket.close()}}function Kn(e,n){const t=[String(e.id??""),e.url,e.webSocketDebuggerUrl],r=[String(n.id??""),n.url,n.webSocketDebuggerUrl];for(let a=0;a<t.length;a++){if(t[a]<r[a])return-1;if(t[a]>r[a])return 1}return 0}function Zn(){return m.join(P.app.getAppPath(),"themes")}function Ht(){const e=m.join(P.app.getPath("userData"),"themes");return f.mkdirSync(e,{recursive:!0}),e}function Xn(){return[Ht(),Zn()]}const yt=new Map;function Le(e){var a;const n=[],t=new Set;for(const o of Xn()){if(!f.existsSync(o))continue;const s=f.readdirSync(o,{withFileTypes:!0});for(const c of s){if(!c.isDirectory())continue;const i=m.join(o,c.name),l=m.join(i,"theme.json");if(f.existsSync(l))try{const d=JSON.parse(f.readFileSync(l,"utf-8")),p=rr(d);if(t.has(p.id))continue;const h=m.join(i,p.hero);if(!f.existsSync(h)||!f.statSync(h).isFile())throw new Error(`theme hero is missing: ${p.hero}`);if(e&&((a=p.apps[e])==null?void 0:a.compat)!==!0&&e!=="hana-agent")continue;t.add(p.id),n.push({id:p.id,name:p.name,author:p.author,path:i,manifest:p})}catch(d){console.error(`Failed to load theme ${c.name}:`,d)}}}const r=new Map;for(const o of n){const s=m.join(o.path,o.manifest.hero),c=Qe(s),i=`${o.name.trim().toLocaleLowerCase()}\0${o.author.trim().toLocaleLowerCase()}\0${c}`,l=r.get(i);(!l||Yn(o.id,l.id))&&r.set(i,o)}return[...r.values()].sort((o,s)=>o.name.localeCompare(s.name))}function Qe(e){const n=f.statSync(e),t=yt.get(e);if(t&&t.size===n.size&&t.mtimeMs===n.mtimeMs)return t.hash;const r=at.createHash("sha256").update(f.readFileSync(e)).digest("hex");return yt.set(e,{size:n.size,mtimeMs:n.mtimeMs,hash:r}),r}function Yn(e,n){const t=e.startsWith("custom-"),r=n.startsWith("custom-");return t!==r?!t:e.length<n.length||e.length===n.length&&e.localeCompare(n)<0}function Ft(e,n){return Le(n).find(t=>t.id===e)}function Qn(e){const n=Ft(e);if(!n)return;const t=m.resolve(n.path,n.manifest.hero);if(t.startsWith(`${m.resolve(n.path)}${m.sep}`))return t}function er(e){return`theme-asset://local/${encodeURIComponent(e)}`}function tr(e){const n=m.resolve(e.path),t=m.resolve(n,e.manifest.hero);if(t!==n&&!t.startsWith(n+m.sep))throw new Error(`Theme hero path escapes theme directory: ${e.manifest.hero}`);const r=f.readFileSync(t);return`data:${ar(e.manifest.hero)};base64,${r.toString("base64")}`}function nr(e,n,t){const r=Qe(t);return Le().some(a=>a.name.trim().toLowerCase()!==e.trim().toLowerCase()||a.author.trim().toLowerCase()!==n.trim().toLowerCase()?!1:Qe(m.join(a.path,a.manifest.hero))===r)}function rr(e){if(typeof e!="object"||e===null||Array.isArray(e))throw new Error("theme manifest must be an object");if(e.schemaVersion!==1)throw new Error(`unsupported theme schema ${e.schemaVersion}`);if(typeof e.id!="string"||!/^[a-z0-9-]+$/.test(e.id))throw new Error("theme id must use lowercase letters, numbers, and hyphens");if(typeof e.name!="string"||!e.name.trim())throw new Error("theme name must be a non-empty string");if(typeof e.author!="string")throw new Error("theme author must be a string");if(typeof e.hero!="string")throw new Error("theme hero must be a string");let n;if(typeof e.video=="string"&&e.video.trim()){const r=e.video.trim();m.basename(r)!==r||!/\.(mp4|webm)$/i.test(r)?console.warn(`theme ${e.id}: ignoring invalid video field ${r}`):n=r}if(typeof e.colors!="object"||e.colors===null)throw new Error("theme colors must be an object");const t=["accent","secondary","surface","text"];for(const r of t)if(typeof e.colors[r]!="string"||!/^#[0-9a-fA-F]{6}$/.test(e.colors[r]))throw new Error(`theme color ${r} must be a hex color`);return{schemaVersion:1,id:e.id,name:e.name.trim(),author:e.author,hero:e.hero,video:n,colors:{accent:e.colors.accent,secondary:e.colors.secondary,surface:e.colors.surface,text:e.colors.text},copy:e.copy??void 0,apps:e.apps??{}}}function ar(e){const n=m.extname(e).toLowerCase();return{".png":"image/png",".jpg":"image/jpeg",".jpeg":"image/jpeg",".webp":"image/webp",".gif":"image/gif",".mp4":"video/mp4",".webm":"video/webm"}[n]||"image/png"}function or(e){const n=e.manifest.video;if(!n)return null;const t=m.resolve(e.path);let r=m.resolve(t,n);if(r!==t&&!r.startsWith(t+m.sep)||!/\.(mp4|webm)$/i.test(m.extname(r)))return null;const a=P.app.getAppPath();if(a.endsWith(".asar")&&(t===a||t.startsWith(a+m.sep))){const o=m.resolve(a+".unpacked",m.relative(a,t));r=m.resolve(o,n)}try{if(!f.existsSync(r)||!f.statSync(r).isFile())return null}catch{return null}return r}const zt=5,sr=32*1024*1024;let Ce=null;function st(){try{const e=JSON.parse(f.readFileSync(qt(),"utf8"));return it(e)}catch{return[]}}function ir(e){const n=it(e),t=[...st()];for(const a of n){const o=t.findIndex(s=>s.id===a.id);o>=0?t[o]=a:t.push(a)}const r=t.slice(0,zt);return Gt(r),r}function cr(e,n,t,r=4){const a=Jt()[e]??{};return[...n].sort((o,s)=>{if(o===t)return-1;if(s===t)return 1;const c=a[o]??{count:0,lastUsedAt:0},i=a[s]??{count:0,lastUsedAt:0};return i.lastUsedAt-c.lastUsedAt||i.count-c.count}).slice(0,r)}function et(e,n){if(!/^[a-z0-9-]+$/i.test(e)||!/^[a-z0-9-]+$/i.test(n))return;const t=Jt(),r=t[e]??{},a=r[n]??{count:0};r[n]={count:a.count+1,lastUsedAt:Date.now()},t[e]=r,Kt(Vt(),t)}function lr(){return Ce||(Ce=new Promise((e,n)=>{const t=at.randomBytes(24).toString("hex"),r=Ut.createServer((a,o)=>{if(o.setHeader("Access-Control-Allow-Origin","*"),o.setHeader("Access-Control-Allow-Headers","Authorization, Content-Type"),o.setHeader("Access-Control-Allow-Methods","GET, PUT, POST, OPTIONS"),o.setHeader("Access-Control-Allow-Private-Network","true"),a.method==="OPTIONS"){o.writeHead(204).end();return}if(a.headers.authorization!==`Bearer ${t}`){o.writeHead(401).end("Unauthorized");return}if(a.url==="/theme-usage"&&a.method==="POST"){vt(a,o,s=>{if(typeof(s==null?void 0:s.appId)!="string"||typeof(s==null?void 0:s.themeId)!="string")throw new Error("Invalid theme usage payload");et(s.appId,s.themeId),Ge(o,200,{success:!0})});return}if(a.url!=="/custom-themes"){o.writeHead(404).end("Not found");return}if(a.method==="GET"){Ge(o,200,st());return}if(a.method!=="PUT"){o.writeHead(405).end("Method not allowed");return}vt(a,o,s=>{const c=it(s);Gt(c),Ge(o,200,c)})});r.once("error",n),r.listen(0,"127.0.0.1",()=>{const a=r.address();if(!a||typeof a=="string"){r.close(),n(new Error("Shared custom theme service did not expose a TCP port"));return}const o=`http://127.0.0.1:${a.port}`;e({endpoint:`${o}/custom-themes`,usageEndpoint:`${o}/theme-usage`,token:t})})}),Ce)}function qt(){return m.join(P.app.getPath("userData"),"custom-themes.json")}function Vt(){return m.join(P.app.getPath("userData"),"theme-usage.json")}function Gt(e){Kt(qt(),e)}function Jt(){try{const e=JSON.parse(f.readFileSync(Vt(),"utf8"));return e&&typeof e=="object"&&!Array.isArray(e)?e:{}}catch{return{}}}function Kt(e,n){f.mkdirSync(m.dirname(e),{recursive:!0}),f.writeFileSync(e,`${JSON.stringify(n,null,2)}
`)}function vt(e,n,t){let r=0;const a=[];e.on("data",o=>{if(r+=o.length,r>sr){n.writeHead(413).end("Payload too large"),e.destroy();return}a.push(o)}),e.on("end",()=>{if(!n.headersSent)try{t(JSON.parse(Buffer.concat(a).toString("utf8")))}catch(o){n.writeHead(400).end(o.message)}})}function it(e){if(!Array.isArray(e))throw new Error("Custom themes must be an array");return e.slice(0,zt).map((n,t)=>{var o,s;if(!n||typeof n!="object")throw new Error(`Invalid custom theme at index ${t}`);const r=n;if(typeof r.id!="string"||!/^custom-[a-z0-9-]+$/i.test(r.id))throw new Error(`Invalid custom theme id at index ${t}`);if(typeof r.name!="string"||!r.name.trim())throw new Error(`Invalid custom theme name at index ${t}`);if(typeof r.dataUrl!="string"||!/^data:image\/(?:png|jpeg|webp);base64,[A-Za-z0-9+/=]+$/.test(r.dataUrl))throw new Error(`Invalid custom theme image at index ${t}`);for(const c of["accent","secondary","surface","text"])if(typeof((o=r.colors)==null?void 0:o[c])!="string"||!/^#[0-9a-fA-F]{6}$/.test(r.colors[c]))throw new Error(`Invalid custom theme color ${c} at index ${t}`);const a=typeof((s=r.colors)==null?void 0:s.average)=="string"&&/^#[0-9a-fA-F]{6}$/.test(r.colors.average)?r.colors.average:void 0;return{id:r.id,name:r.name.trim(),dataUrl:r.dataUrl,colors:{accent:r.colors.accent,secondary:r.colors.secondary,surface:r.colors.surface,text:r.colors.text,...a?{average:a}:{}}}})}function Ge(e,n,t){e.writeHead(n,{"Content-Type":"application/json; charset=utf-8"}),e.end(JSON.stringify(t))}function le(e){const n=/^#([0-9a-f]{6})$/i.exec(e);if(!n)return[255,255,255];const t=parseInt(n[1],16);return[t>>16&255,t>>8&255,t&255]}function oe(e){return"#"+e.map(n=>Math.max(0,Math.min(255,Math.round(n))).toString(16).padStart(2,"0")).join("")}function Je(e){const n=e/255;return n<=.04045?n/12.92:Math.pow((n+.055)/1.055,2.4)}function Pe(e){return .2126*Je(e[0])+.7152*Je(e[1])+.0722*Je(e[2])}function ne(e,n){const t=Pe(e),r=Pe(n);return(Math.max(t,r)+.05)/(Math.min(t,r)+.05)}function re(e,n,t){return[0,1,2].map(r=>e[r]+(n[r]-e[r])*t)}function ct(e){const n=e[0]/255,t=e[1]/255,r=e[2]/255,a=Math.max(n,t,r),o=Math.min(n,t,r),s=(a+o)/2;if(a===o)return[0,0,s];const c=a-o,i=s>.5?c/(2-a-o):c/(a+o);let l;return a===n?l=(t-r)/c+(t<r?6:0):a===t?l=(r-n)/c+2:l=(n-t)/c+4,[l/6,i,s]}function we(e,n,t){if(n<=0){const s=t*255;return[s,s,s]}const r=(s,c,i)=>(i<0&&(i+=1),i>1&&(i-=1),i<1/6?s+(c-s)*6*i:i<1/2?c:i<2/3?s+(c-s)*(2/3-i)*6:s),a=t<.5?t*(1+n):t+n-t*n,o=2*t-a;return[r(o,a,e+1/3)*255,r(o,a,e)*255,r(o,a,e-1/3)*255]}function dr(e,n,t){if(ne(e,n)>=t)return e;const r=t+Math.max(.02,t*.02),a=Pe(e),o=Pe(n),s=a<o||a===o&&o>.475,[c,i,l]=ct(e);if(i>=.02){let g=s?0:l,b=s?l:1;for(let _=0;_<14;_++){const N=(g+b)/2;ne(we(c,i,N),n)>=r?s?g=N:b=N:s?b=N:g=N}const w=we(c,i,s?g:b);if(ne(w,n)>=t)return w}const d=s?[0,0,0]:[255,255,255];let p=0,h=1;for(let g=0;g<12;g++){const b=(p+h)/2;ne(re(e,d,b),n)>=r?h=b:p=b}return re(e,d,h)}function Se(e,n,t){if(n.length===0)return e;const r=d=>Math.min(...n.map(p=>ne(d,p)));let a=e;for(let d=0;d<4;d++){if(r(a)>=t)return a;const p=r(a);let h=n[0],g=1/0;for(const w of n){const _=ne(a,w);_<g&&(g=_,h=w)}const b=dr(a,h,t);if(r(b)<=p+1e-9)break;a=b}if(r(a)>=t)return a;const[o,s]=ct(e),c=[e,a];for(const d of[.02,.06,.12,.22,.78,.88,.95,.99])c.push(we(o,s,d));let i=a,l=r(a);for(const d of c){const p=r(d);p>l+1e-9&&(l=p,i=d)}return i}function mr(e){if(e.length<16||e.readUInt32BE(0)!==2303741511)return null;let n=8,t=-1;const r=[];for(;n+12<=e.length;){const o=e.readUInt32BE(n),s=e.toString("ascii",n+4,n+8),c=e.subarray(n+8,n+8+o);if(s==="IHDR"){const i=c.readUInt32BE(0),l=c.readUInt32BE(4),d=c[8],p=c[12];if(i!==1||l!==1||d!==8||p!==0)return null;t=c[9]}else if(s==="IDAT")r.push(c);else if(s==="IEND")break;n+=12+o}if(t<0||r.length===0)return null;let a;try{a=wn.inflateSync(Buffer.concat(r))}catch{return null}if(a.length<2||a[0]>4)return null;switch(t){case 6:return a.length>=5?[a[1],a[2],a[3]]:null;case 2:return a.length>=4?[a[1],a[2],a[3]]:null;case 4:return a.length>=3?[a[1],a[1],a[1]]:null;case 0:return a.length>=2?[a[1],a[1],a[1]]:null;default:return null}}function ur(){return String.raw`(function () {
...
`}const pr=30*60*1e3,hr=30*1e3,gr=128e3,Te=96;function Ae(){return m.join(L.homedir(),".zcode","cli","db")}function fr(){const e=Ae();let n=0;for(const t of["db.sqlite","db.sqlite-wal","db.sqlite-shm"])try{n=Math.max(n,f.statSync(m.join(e,t)).mtimeMs)}catch{}return n}function Re(e,n){let t=0;for(let a=0;a<8;a++){const o=e[n+a];if(o===void 0)throw new Error("varint out of range");if(t=t*128+(o&127),!(o&128))return{value:t,next:n+a+1}}const r=e[n+8];if(r===void 0)throw new Error("varint out of range");return t=t*256+r,{value:t,next:n+9}}function br(e,n,t){let r=0;for(let a=0;a<t;a++)r=r*256+e[n+a];return t<8&&r>=Math.pow(2,t*8-1)&&(r-=Math.pow(2,t*8)),r}function kt(e){try{const n=Re(e,0),t=n.value;if(t>e.length)return null;let r=n.next,a=t;const o=[];for(;r<t;){const s=Re(e,r);r=s.next;const c=s.value;if(c===0){o.push(null);continue}if(c>=1&&c<=6){const i=[0,1,2,3,4,6,8][c];o.push(br(e,a,i)),a+=i;continue}if(c===7){o.push(e.readDoubleBE(a)),a+=8;continue}if(c===8){o.push(0);continue}if(c===9){o.push(1);continue}if(c>=12&&c%2===0){const i=(c-12)/2;o.push(null),a+=i;continue}if(c>=13){const i=(c-13)/2;o.push(e.toString("utf8",a,a+i)),a+=i;continue}return null}return o}catch{return null}}function xr(e){const n=e.indexOf("(");if(n<0)return[];const t=h=>h==='"'||h==="'"||h.charCodeAt(0)===Te,r=(h,g)=>{const b=h[g];if(t(b)){for(g++;g<h.length&&h[g]!==b;)g++;return g}if(b==="["){const w=h.indexOf("]",g);return w<0?h.length:w}return g};let a=0,o=-1;for(let h=n;h<e.length;h++){const g=r(e,h);if(g!==h){h=g;continue}if(e[h]==="(")a++;else if(e[h]===")"&&(a--,a===0)){o=h;break}}if(o<0)return[];const s=e.slice(n+1,o),c=[];let i="",l=0;for(let h=0;h<s.length;h++){const g=r(s,h);if(g!==h){i+=s.slice(h,g+1),h=g;continue}if(s[h]==="("?l++:s[h]===")"&&l--,s[h]===","&&l===0){c.push(i),i="";continue}i+=s[h]}i.trim()&&c.push(i);const d=new Set(["PRIMARY","UNIQUE","CHECK","FOREIGN","CONSTRAINT"]),p=[];for(const h of c){const g=h.trim();if(!g)continue;let b="";if(g.startsWith('"')){const w=g.indexOf('"',1);b=g.slice(1,w>0?w:1)}else if(g.startsWith("[")){const w=g.indexOf("]",1);b=g.slice(1,w>0?w:1)}else if(g.charCodeAt(0)===Te){const w=String.fromCharCode(Te),_=g.indexOf(w,1);b=g.slice(1,_>0?_:1)}else{const w=g.match(/^([A-Za-z_][A-Za-z0-9_]*)/);w&&(b=w[1])}b&&(!g.startsWith('"')&&!g.startsWith("[")&&g.charCodeAt(0)!==Te&&d.has(b.toUpperCase())||p.push(b))}return p}function Ke(e,n,t,r,a,o){for(let s=n;s+8<=n+t;s+=8){const c=r?e.readUInt32BE(s):e.readUInt32LE(s),i=r?e.readUInt32BE(s+4):e.readUInt32LE(s+4);a=a+c+o>>>0,o=o+i+a>>>0}return[a,o]}class lt{constructor(n,t,r){D(this,"fd");D(this,"pageSize");D(this,"reserved");D(this,"wal",new Map);D(this,"cache",new Map);this.fd=n,this.pageSize=t,this.reserved=r}static open(n){const t=f.openSync(n,"r");try{const r=Buffer.alloc(100);let a=0;for(;a<100;){const i=f.readSync(t,r,a,100-a,a);if(i<=0)throw new Error("short header read");a+=i}if(r.toString("latin1",0,16)!=="SQLite format 3\0")throw new Error("not a sqlite database");let o=r.readUInt16BE(16);if(o===1&&(o=65536),o<512||o&o-1)throw new Error("invalid page size");const s=r[20];if(r.readUInt32BE(56)!==1)throw new Error("unsupported text encoding");const c=new lt(t,o,s);return c.loadWal(n+"-wal"),c}catch(r){try{f.closeSync(t)}catch{}throw r}}close(){try{f.closeSync(this.fd)}catch{}}loadWal(n){let t;try{t=f.readFileSync(n)}catch{return}if(t.length<32)return;const r=t.readUInt32BE(0);if(r!==931071618&&r!==931071619)return;const a=r===931071619;if(t.readUInt32BE(8)!==this.pageSize)return;const o=t.readUInt32BE(16),s=t.readUInt32BE(20);let c=0,i=0;if([c,i]=Ke(t,0,24,a,c,i),c!==t.readUInt32BE(24)||i!==t.readUInt32BE(28))return;const l=24+this.pageSize;let d=32;for(;d+l<=t.length;){const p=t.readUInt32BE(d);if(t.readUInt32BE(d+8)!==o||t.readUInt32BE(d+12)!==s||([c,i]=Ke(t,d,8,a,c,i),[c,i]=Ke(t,d+24,this.pageSize,a,c,i),c!==t.readUInt32BE(d+16)||i!==t.readUInt32BE(d+20)))break;p>=1&&this.wal.set(p,t.subarray(d+24,d+24+this.pageSize)),d+=l}}page(n){const t=this.cache.get(n);if(t)return t;const r=this.wal.get(n);if(r)return this.cache.set(n,r),r;if(n>2147483647)return null;const a=Buffer.alloc(this.pageSize);let o=0;try{for(;o<this.pageSize;){const s=f.readSync(this.fd,a,o,this.pageSize-o,(n-1)*this.pageSize+o);if(s<=0)break;o+=s}}catch{return null}return o===0?null:(this.cache.set(n,a),a)}walkTable(n,t,r){if(r>30)return;const a=this.page(n);if(!a)return;const o=n===1?100:0,s=a[o];let c=0;try{c=a.readUInt16BE(o+3)}catch{return}if(s===13){const i=this.pageSize-this.reserved,l=i-35,d=Math.floor((i-12)*32/255)-23;for(let p=0;p<c;p++)try{const h=a.readUInt16BE(o+8+p*2),g=Re(a,h),b=Re(a,g.next),w=g.value;let _=w,N=0;if(w>l&&(_=d+(w-d)%(i-4),_>l&&(_=d),N=a.readUInt32BE(b.next+_)),N===0){if(b.next+w>a.length)continue;t(b.value,a.subarray(b.next,b.next+w));continue}const y=Buffer.alloc(w);a.copy(y,0,b.next,b.next+_);let C=_,O=N,S=!1;for(;O&&C<w;){const A=this.page(O);if(!A){S=!0;break}const R=A.readUInt32BE(0),q=Math.min(w-C,i-4);A.copy(y,C,4,4+q),C+=q,O=R}if(S||C!==w)continue;t(b.value,y)}catch{continue}}else if(s===5)try{for(let i=0;i<c;i++){const l=a.readUInt16BE(o+12+i*2);this.walkTable(a.readUInt32BE(l),t,r+1)}this.walkTable(a.readUInt32BE(o+8),t,r+1)}catch{return}}tableRoots(){const n=new Map;return this.walkTable(1,(t,r)=>{const a=kt(r);a&&a[0]==="table"&&typeof a[1]=="string"&&typeof a[3]=="number"&&typeof a[4]=="string"&&n.set(a[1],{root:a[3],sql:a[4]})},0),n}scanTable(n,t,r,a){const o=xr(t);if(!o.length)return;const s=[];for(const c of r){const i=o.indexOf(c);i>=0&&s.push([c,i])}this.walkTable(n,(c,i)=>{const l=kt(i);if(!l)return;const d={};for(const[p,h]of s)d[p]=l[h]??null;a(d)},0)}}const Ct={requests:0,retries:0,toolCalls:0,toolErrors:0,input:0,output:0,reasoning:0,cacheRead:0,cacheWrite:0,total:0,durationMs:0,ttftMs:0};function v(e){return typeof e=="number"&&Number.isFinite(e)?e:0}function B(e){return typeof e=="string"?e:""}function wr(e){if(!e)return"";const n=new Date(e),t=r=>(r<10?"0":"")+r;return t(n.getHours())+":"+t(n.getMinutes())+":"+t(n.getSeconds())}let $e=null;function yr(){if($e&&Date.now()-$e.at<6e5)return $e.map;const e=new Map;try{const n=Ne.find(r=>r.id==="zcode"),t=new Set([...((n==null?void 0:n.installPaths)??[]).map(r=>m.join(r,"resources","model-providers")),"D:\\ZCode\\resources\\model-providers"]);for(const r of t){let a=[];try{a=f.readdirSync(r).filter(o=>o.toLowerCase().endsWith(".json"))}catch{continue}for(const o of a)try{const s=JSON.parse(f.readFileSync(m.join(r,o),"utf8"));for(const c of Array.isArray(s==null?void 0:s.providers)?s.providers:[])for(const i of Array.isArray(c==null?void 0:c.models)?c.models:[]){const l=String((i==null?void 0:i.id)??"").trim().toLowerCase(),d=Number(i==null?void 0:i.contextWindow);l&&Number.isFinite(d)&&d>0&&e.set(l,d)}}catch{}}}catch{}return $e={at:Date.now(),map:e},e}function vr(e,n){const t=e.get(n);if(t!==void 0)return t;let r="",a;for(const[o,s]of e)o.length>r.length&&n.startsWith(o+"-")&&(r=o,a=s);return a}function Ze(){return{requests:0,input:0,output:0,reasoning:0,cacheRead:0,cacheWrite:0,total:0,toolCalls:0,retries:0,lastAt:0,lastIn:0,last:null,ctxExc:0}}function kr(e=[]){var r,a;const n=m.join(Ae(),"db.sqlite");let t;try{t=lt.open(n)}catch(o){return console.warn("[usage-db] open failed:",o.message),null}try{const o=t.tableRoots(),s=["model_usage","turn_usage","tool_usage","session"];for(const u of s)if(!o.has(u))return console.warn("[usage-db] table missing:",u),null;const c=new Date;c.setHours(0,0,0,0);const i=c.getTime(),l=i+864e5,d=Date.now(),p=new Map,h=new Map,g=new Map,b=new Map,w={requests:0,input:0,output:0,cacheRead:0,cacheWrite:0,reasoning:0,total:0,retries:0},_=o.get("model_usage");t.scanTable(_.root,_.sql,["session_id","turn_id","status","started_at","completed_at","duration_ms","time_to_first_token_ms","first_token_at","output_tokens","input_tokens","reasoning_tokens","cache_read_input_tokens","cache_creation_input_tokens","computed_total_tokens","tool_call_count","retry_count","model_id","query_source","context_exceeded"],u=>{const x=B(u.session_id);if(!x)return;const k=B(u.status),T=v(u.completed_at);if(k==="completed"){const U=B(u.query_source)==="subagent";let $=U?h.get(x):p.get(x);$||($=Ze(),(U?h:p).set(x,$));const Y=v(u.input_tokens);$.requests++;const z=B(u.turn_id);if(z){let F=g.get(x);F||(F=new Set,g.set(x,F)),F.add(z)}$.input+=Y,$.output+=v(u.output_tokens),$.reasoning+=v(u.reasoning_tokens),$.cacheRead+=v(u.cache_read_input_tokens),$.cacheWrite+=v(u.cache_creation_input_tokens),$.total+=v(u.computed_total_tokens),$.toolCalls+=v(u.tool_call_count),$.retries+=v(u.retry_count),T>$.lastAt&&($.lastAt=T);const ke=$.last;(!ke||T>=ke.completedAt)&&($.last={durationMs:v(u.duration_ms),ttftMs:v(u.time_to_first_token_ms),model:B(u.model_id),output:v(u.output_tokens),firstTokenAt:v(u.first_token_at),completedAt:T,turnId:B(u.turn_id)},$.lastIn=Y),T>=i&&T<l&&(w.requests++,w.input+=Y,w.output+=v(u.output_tokens),w.cacheRead+=v(u.cache_read_input_tokens),w.cacheWrite+=v(u.cache_creation_input_tokens),w.reasoning+=v(u.reasoning_tokens),w.total+=v(u.computed_total_tokens),w.retries+=v(u.retry_count))}if(v(u.context_exceeded)===1){const U=T||v(u.started_at);let $=p.get(x);$||($=Ze(),p.set(x,$)),U>$.ctxExc&&($.ctxExc=U)}if(k==="running"){const U=v(u.started_at);U>(b.get(x)??0)&&b.set(x,U)}});const N=new Map,y=new Map,C=o.get("turn_usage");t.scanTable(C.root,C.sql,["session_id","turn_id","status","started_at","completed_at","model_request_count","model_retry_count","tool_call_count","tool_error_count","input_tokens","output_tokens","reasoning_tokens","cache_read_input_tokens","cache_creation_input_tokens","computed_total_tokens","duration_ms","time_to_first_token_ms"],u=>{const x=B(u.session_id),k=B(u.turn_id);if(!x||!k)return;const T=B(u.status),U=v(u.completed_at)||v(u.started_at),$=y.get(x);U&&(!$||U>=$.at)&&y.set(x,{status:T,at:U}),T==="completed"&&N.set(x+"|"+k,{requests:v(u.model_request_count),retries:v(u.model_retry_count),toolCalls:v(u.tool_call_count),toolErrors:v(u.tool_error_count),input:v(u.input_tokens),output:v(u.output_tokens),reasoning:v(u.reasoning_tokens),cacheRead:v(u.cache_read_input_tokens),cacheWrite:v(u.cache_creation_input_tokens),total:v(u.computed_total_tokens),durationMs:v(u.duration_ms),ttftMs:v(u.time_to_first_token_ms)})});const O=new Map,S=new Map,A=o.get("tool_usage");t.scanTable(A.root,A.sql,["session_id","tool_name","status","duration_ms","started_at"],u=>{const x=B(u.session_id),k=B(u.status);if(!x)return;if(k==="running"){const Y=v(u.started_at);Y>(S.get(x)??0)&&S.set(x,Y);return}if(k!=="completed"&&k!=="error")return;const T=B(u.tool_name)||"(unknown)";let U=O.get(x);U||(U={total:0,errors:0,list:new Map},O.set(x,U));let $=U.list.get(T);$||($={count:0,durationMs:0,errors:0},U.list.set(T,$)),U.total++,$.count++,$.durationMs+=v(u.duration_ms),k==="error"&&(U.errors++,$.errors++)});const R=new Map,q=o.get("session");t.scanTable(q.root,q.sql,["id","title","parent_id","summary_additions","summary_deletions","summary_files"],u=>{const x=B(u.id);x&&R.set(x,{title:B(u.title),parent:typeof u.parent_id=="string"&&u.parent_id?u.parent_id:null,add:typeof u.summary_additions=="number"?u.summary_additions:null,del:typeof u.summary_deletions=="number"?u.summary_deletions:null,files:typeof u.summary_files=="number"?u.summary_files:null})});let X="",V=0;for(const[u,x]of p)x.lastAt>V&&(V=x.lastAt,X=u);const ye=u=>[...p.entries()].filter(([x])=>x.startsWith("sess_subagent")===u).sort((x,k)=>k[1].lastAt-x[1].lastAt).slice(0,6).map(([x])=>x),te=[],ve=u=>{u&&/^[A-Za-z0-9_-]{1,255}$/.test(u)&&!te.includes(u)&&te.push(u)};for(const u of e)ve(u);ve(X),ye(!1).forEach(ve),ye(!0).forEach(ve);const We=new Set;for(const u of te){const x=((a=(r=p.get(u))==null?void 0:r.last)==null?void 0:a.turnId)??"";x&&!N.has(u+"|"+x)&&We.add(u+"|"+x)}const He=new Map;We.size&&t.scanTable(_.root,_.sql,["session_id","turn_id","status","input_tokens","output_tokens","computed_total_tokens","duration_ms","cache_read_input_tokens","reasoning_tokens","cache_creation_input_tokens"],u=>{if(B(u.status)!=="completed")return;const x=B(u.session_id)+"|"+B(u.turn_id);if(!We.has(x))return;let k=He.get(x);k||(k={...Ct},He.set(x,k)),k.requests++,k.input+=v(u.input_tokens),k.output+=v(u.output_tokens),k.total+=v(u.computed_total_tokens),k.durationMs+=v(u.duration_ms),k.cacheRead+=v(u.cache_read_input_tokens),k.reasoning+=v(u.reasoning_tokens),k.cacheWrite+=v(u.cache_creation_input_tokens)});const sn=yr(),mt=u=>{var gt;const x=p.get(u)??Ze(),k=R.get(u),T=x.last;let U=0;if(T&&T.output>0){let M=0;T.firstTokenAt&&T.completedAt>T.firstTokenAt?M=T.completedAt-T.firstTokenAt:M=T.durationMs,M>0&&(U=Math.round(T.output/(M/1e3)*10)/10)}const $=(T==null?void 0:T.turnId)??"",Y=$&&N.get(u+"|"+$)||$&&He.get(u+"|"+$)||{...Ct},z=O.get(u),ke={total:(z==null?void 0:z.total)??0,errors:(z==null?void 0:z.errors)??0,list:[...(z==null?void 0:z.list.entries())??[]].map(([M,E])=>({name:M,count:E.count,durationMs:E.durationMs,errors:E.errors})).sort((M,E)=>E.count-M.count||(M.name<E.name?-1:1))},F=[...h.entries()].filter(([M])=>{var E;return((E=R.get(M))==null?void 0:E.parent)===u}).sort((M,E)=>E[1].lastAt-M[1].lastAt).map(([M,E])=>{var ft;return{sid:M,title:((ft=R.get(M))==null?void 0:ft.title)??"",task:"",requests:E.requests,total:E.total,input:E.input,output:E.output,cacheRead:E.cacheRead,reasoning:E.reasoning,cacheWrite:E.cacheWrite,last:E.lastAt,active:d-E.lastAt<hr}}),ln={requests:F.reduce((M,E)=>M+E.requests,0),total:F.reduce((M,E)=>M+E.total,0),input:F.reduce((M,E)=>M+E.input,0),output:F.reduce((M,E)=>M+E.output,0),cacheRead:F.reduce((M,E)=>M+E.cacheRead,0),reasoning:F.reduce((M,E)=>M+E.reasoning,0),cacheWrite:F.reduce((M,E)=>M+E.cacheWrite,0),active:F.some(M=>M.active),list:F},pt=((T==null?void 0:T.model)??"").trim().toLowerCase(),ht=pt?vr(sn,pt):void 0,Fe=S.get(u)??0,ze=b.get(u)??0,K=y.get(u);let ue="idle",pe=0;return Fe&&d-Fe<6e5?(ue="running",pe=Fe):ze&&d-ze<6e5?(ue="thinking",pe=ze):K&&(K.status==="error"||K.status==="cancelled")&&d-K.at<12e3?(ue="failed",pe=K.at):K&&K.status==="completed"&&d-K.at<8e3&&(ue="done",pe=K.at),{sid:u,title:(k==null?void 0:k.title)??"",active:x.lastAt>0&&d-x.lastAt<pr,turns:((gt=g.get(u))==null?void 0:gt.size)??0,requests:x.requests,input:x.input,output:x.output,reasoning:x.reasoning,cacheRead:x.cacheRead,cacheWrite:x.cacheWrite,total:x.total,toolCalls:x.toolCalls,retries:x.retries,ctx:x.lastIn,updated:wr(x.lastAt),lastAt:x.lastAt,live:{state:ue,at:pe},last:{durationMs:(T==null?void 0:T.durationMs)??0,ttftMs:(T==null?void 0:T.ttftMs)??0,model:(T==null?void 0:T.model)??"",tps:U},lastTurn:Y,tools:ke,sub:ln,code:{add:(k==null?void 0:k.add)??null,del:(k==null?void 0:k.del)??null,files:(k==null?void 0:k.files)??null},ctxExc:x.ctxExc,contextWindow:ht??gr,contextAuto:ht!==void 0,isSub:u.startsWith("sess_subagent"),parent:(k==null?void 0:k.parent)??null}},ut=te.map(mt),cn=X?ut.find(u=>u.sid===X)??mt(X):null;return{v:1,generatedAt:d,today:w,session:cn,recent:ut}}catch(o){return console.warn("[usage-db] snapshot failed:",o.message),null}finally{t.close()}}const St=1500,Cr=3e4,Sr=300,j=new Map;function ie(...e){console.error("[usage-pump]",...e)}async function Zt(e){var t;const n=((t=W("zcode"))==null?void 0:t.rendererHints)??["out/renderer/index.html","renderer/index.html"];for(const r of n)try{const a=await me(e,r,{timeoutMs:1500,quiet:!0});if(a.length>0)return a}catch{}try{const a=await(await fetch(`http://127.0.0.1:${e}/json/list`,{signal:AbortSignal.timeout(3e3)})).json();return(Array.isArray(a)?a:[]).filter(je)}catch{return[]}}async function tt(e,n){return await Promise.race([e,new Promise(t=>setTimeout(()=>t(null),n))])}async function Tr(e,n,t=!1){const r=await Zt(e);if(r.length===0)return;const a=[];for(const d of r){const p=new J(d.webSocketDebuggerUrl);try{await p.open();const h=await tt(p.evaluate("(window.__dreamWorkUsageWant || '')"),1500),g=typeof h=="string"?h.trim():"";g&&/^[A-Za-z0-9_-]{1,255}$/.test(g)&&!a.includes(g)&&a.push(g)}catch{}finally{p.close()}}const o=fr(),s=a.join(",");if(!t&&s===n.lastWants&&o>0&&o===n.lastStamp)return;const c=Date.now();if(c-n.lastSpawnAt<St){$r(e,St-(c-n.lastSpawnAt)+50);return}n.lastWants=s,o&&(n.lastStamp=o),n.lastSpawnAt=c;const i=kr(a);if(!i)return;const l="window.__dreamWorkUsageUpdate && window.__dreamWorkUsageUpdate("+JSON.stringify(i).replace(/[\u2028\u2029]/g,d=>d==="\u2028"?"\\u2028":"\\u2029")+")";for(const d of r){const p=new J(d.webSocketDebuggerUrl);try{await p.open(),await tt(p.evaluate(l),5e3)}catch{}finally{p.close()}}t||(n.settleTimer&&clearTimeout(n.settleTimer),n.settleTimer=setTimeout(()=>{const d=j.get(e);d&&(d.settleTimer=null),ae(e,!0)},2500))}function $r(e,n){const t=j.get(e);t&&(t.retryTimer&&clearTimeout(t.retryTimer),t.retryTimer=setTimeout(()=>{const r=j.get(e);r&&(r.retryTimer=null,ae(e))},Math.max(50,n)))}let Xe=!1;async function ae(e,n=!1){const t=j.get(e);if(!(!t||t.busy||Xe)){t.busy=!0,Xe=!0;try{await Tr(e,t,n)}catch(r){ie("cycle failed:",r.message)}finally{t.busy=!1,Xe=!1}}}function Ue(e){const n=j.get(e);if(!(!n||n.watcher))try{n.watcher=f.watch(Ae(),(t,r)=>{if(r&&!/db\.sqlite/.test(r))return;const a=j.get(e);a&&(a.debounceTimer&&clearTimeout(a.debounceTimer),a.debounceTimer=setTimeout(()=>{const o=j.get(e);o&&(o.debounceTimer=null,ae(e))},Sr))}),n.watcher.on("error",()=>{ie("db watcher error, re-arm in 5s");const t=j.get(e);if(t!=null&&t.watcher){try{t.watcher.close()}catch{}t.watcher=null}setTimeout(()=>{j.has(e)&&Ue(e)},5e3)}),ie("watching",Ae(),"for port",e)}catch(t){ie("fs.watch failed, retry in 5s:",t.message),setTimeout(()=>{j.has(e)&&Ue(e)},5e3)}}let Me=null;async function Er(e){const n=j.get(e);if(!n||n.busy)return;const t=await Zt(e).catch(()=>[]),r=t&&t[0];if(!r)return;const a=new J(r.webSocketDebuggerUrl);try{await a.open();const o=await tt(a.evaluate("(window.__dreamWorkUsageWant || '')"),1200),s=typeof o=="string"?o.trim():"";s&&/^[A-Za-z0-9_-]{1,255}$/.test(s)&&!n.lastWants.split(",").includes(s)&&ae(e)}catch{}finally{a.close()}}function Xt(e){let n=j.get(e);if(n){n.watcher||Ue(e);return}n={watcher:null,heartbeat:null,retryTimer:null,debounceTimer:null,settleTimer:null,busy:!1,lastSpawnAt:0,lastStamp:0,lastWants:""},j.set(e,n),Ue(e),n.heartbeat=setInterval(()=>void ae(e,!0),Cr),Me=setInterval(()=>void Er(e),2e3),[3e3,8e3,15e3].forEach(t=>setTimeout(()=>{j.has(e)&&ae(e,!0)},t)),ie("started for port",e,"(forced heartbeat + startup ramp, 0.7.8)"),ae(e)}function _r(e){const n=j.get(e);if(n){if(j.delete(e),n.watcher)try{n.watcher.close()}catch{}n.heartbeat&&clearInterval(n.heartbeat),n.retryTimer&&clearTimeout(n.retryTimer),n.debounceTimer&&clearTimeout(n.debounceTimer),n.settleTimer&&clearTimeout(n.settleTimer),Me&&(clearInterval(Me),Me=null),ie("stopped for port",e)}}function Mr(e){return j.has(e)}const Z="dream-work-style",H="dream-work-menu",ce=new Map,ge=new Map,ee=new Map,fe=new Map,I={id:"wb-dream-sentinel-id",hero:"data:image/png;base64,WBDREAMHEROSENTINEL",accent:"#010203",secondary:"#040506",surface:"#070809",text:"#0a0b0c",textSubtle:"#0d0e0f",textSubtlest:"#101112",textSecondary:"#131415"},Ir={zcode:[.7,.76,.88,.9],codex:[.76,.82,.86,.9,.92],catpaw:[.78,.82],"qoder-work":[.7,.82,.86,.9],"qwen-office":[.86,.9],workbuddy:[.58,.62,.92],"hana-agent":[.62,.66,.78]},Yt=[.7,.76,.88,.9];function nt(e){return Ir[e]??Yt}function Qt(e){if(e)return"file:///"+encodeURI(e.replace(/\\/g,"/")).replace(/#/g,"%23").replace(/\?/g,"%3F")}let Ee=null;function Pr(){if(Ee)return Ee.length?Ee:void 0;const e=[];try{const n=P.app.getAppPath(),t=a=>n.endsWith(".asar")&&(a===n||a.startsWith(n+m.sep)),r=m.resolve(m.join(n,"assets","pet"));for(const a of f.readdirSync(r)){if(a!==m.basename(a))continue;const o=m.resolve(r,a);if(o!==r&&!o.startsWith(r+m.sep))continue;try{if(!f.statSync(o).isDirectory())continue}catch{continue}let s={};try{s=JSON.parse(f.readFileSync(m.join(o,"pet.json"),"utf8"))}catch{}const c={};try{for(const i of f.readdirSync(o)){const l=m.extname(i).toLowerCase();if(![".gif",".webp",".png"].includes(l)||i!==m.basename(i))continue;const d=i.slice(0,-l.length);if(c[d]&&l!==".webp")continue;let p=m.join(o,i);if(t(p)){const b=m.resolve(n+".unpacked",m.relative(n,p));f.existsSync(b)&&(p=b)}const h=Qt(p);if(!h)continue;let g=0;try{g=Math.round(f.statSync(p).mtimeMs)}catch{}c[d]=g?h+"?v="+g:h}}catch{}Object.keys(c).length&&e.push({id:String(s.id||a),name:String(s.name||a),order:Number.isFinite(Number(s.order))?Number(s.order):99,scale:Number.isFinite(Number(s.scale))&&Number(s.scale)>0?Number(s.scale):.5,states:c})}e.sort((a,o)=>a.order-o.order||(a.id<o.id?-1:1))}catch(n){console.warn("[injector] pet registry unavailable:",n.message)}return Ee=e,e.length?e:void 0}const Tt=new Map;function Ar(e){let n;try{n=f.statSync(e)}catch{return null}const t=Tt.get(e);if(t&&t.size===n.size&&t.mtimeMs===n.mtimeMs)return t.rgb;let r=null;try{const a=P.nativeImage.createFromPath(e);if(!a.isEmpty()){const o=a.resize({width:1,height:1}).toDataURL();r=mr(Buffer.from(o.slice(o.indexOf(",")+1),"base64"))}}catch(a){console.warn("[injector] Hero average sampling failed:",a.message)}return Tt.set(e,{size:n.size,mtimeMs:n.mtimeMs,rgb:r}),r}let _e=null;async function Rr(){if(!_e)try{const e=m.resolve(__dirname,"manager","codex-dream-skin.css");_e=await bn.readFile(e,"utf-8")}catch(e){console.warn("[injector] Failed to load Codex base CSS:",e.message),_e=""}return _e}async function en(e,n,t,r={}){const a=W(e),o=r.rendererUrlHint?[r.rendererUrlHint]:(a==null?void 0:a.rendererHints)??["renderer/index.html","index.html"];let s=[],c="No renderer targets found";for(const i of o)try{if(console.log(`[injector] Trying hint "${i}" on port ${t}`),s=await Jn(t,i,{timeoutMs:2e4,pollMs:500}),s.length>0){console.log(`[injector] Found ${s.length} targets with hint "${i}"`);break}}catch(l){c=l.message,console.log(`[injector] Hint "${i}" failed: ${l.message}`)}if(s.length===0)try{console.log(`[injector] Strict hints failed, trying relaxed page-target fallback on port ${t}`);const l=await(await fetch(`http://127.0.0.1:${t}/json/list`,{signal:AbortSignal.timeout(5e3)})).json(),d=(Array.isArray(l)?l:[]).filter(je).sort((p,h)=>{const g=[String(p.id??""),p.url,p.webSocketDebuggerUrl],b=[String(h.id??""),h.url,h.webSocketDebuggerUrl];for(let w=0;w<g.length;w++){if(g[w]<b[w])return-1;if(g[w]>b[w])return 1}return 0});d.length>0&&(console.log(`[injector] Relaxed fallback found ${d.length} page targets`),s=d)}catch(i){console.log(`[injector] Relaxed fallback failed: ${i.message}`)}if(s.length===0)return{success:!1,applied:0,error:c};try{const i=Le(e);if(console.log(`[injector] Loaded ${i.length} themes`),!i.some(y=>y.id===n))return{success:!1,applied:0,error:`Theme ${n} is not compatible with ${e}`};const l=cr(e,i.map(y=>y.id),n,8),d=new Map(i.map(y=>[y.id,y])),p=l.map(y=>d.get(y)).filter(Boolean),h=new Map;for(const y of p){const C=e==="zcode"?or(y):null;h.set(y.id,{name:y.name,css:_t(e,y.manifest,tr(y),Ar(m.join(y.path,y.manifest.hero)),{video:!!C}),surface:y.manifest.colors.surface,videoUrl:Qt(C)})}const g=Array.from(h.entries()).map(([y,C])=>{var O;return{id:y,name:C.name,css:C.css,surface:C.surface,accent:((O=i.find(S=>S.id===y))==null?void 0:O.manifest.colors.accent)??"#24c9d7",videoUrl:C.videoUrl}});let b=st();if(b.length===0){const y=e==="workbuddy"?"dreamCustomThemes":"dreamCodexCustomThemes";for(const C of s){const O=new J(C.webSocketDebuggerUrl);try{await O.open();const S=await O.evaluate(`(() => localStorage.getItem(${JSON.stringify(y)}) || '[]')()`),A=JSON.parse(S);if(Array.isArray(A)&&A.length>0){b=ir(A);break}}catch(S){console.warn(`[injector] Failed to import existing custom themes from ${e} target ${C.id}:`,S)}finally{O.close()}}}const w=await lr(),_=e==="workbuddy"?Xr({styleId:Z,menuId:H,currentThemeId:n,themes:g,sharedCustomThemes:b,sharedCustomThemeService:w,cssTemplate:nn({id:I.id,colors:{accent:I.accent,secondary:I.secondary,surface:I.surface,text:I.text},copy:null},I.hero,{accent:I.accent,secondary:I.secondary,surface:I.surface,text:I.text})}):e==="hana-agent"?Vr({styleId:Z,menuId:H,currentThemeId:n,themes:g,sharedCustomThemes:b,sharedCustomThemeService:w,cssTemplate:tn({id:I.id,colors:{accent:I.accent,secondary:I.secondary,surface:I.surface,text:I.text}},I.hero,{accent:I.accent,secondary:I.secondary,surface:I.surface,text:I.text})}):Yr({styleId:Z,menuId:H,currentThemeId:n,appId:e,themes:g,sharedCustomThemes:b,sharedCustomThemeService:w,cssTemplate:_t(e,{id:I.id,colors:{accent:I.accent,secondary:I.secondary,surface:I.surface,text:I.text}},I.hero,null,{template:!0}),surfaceAlphas:nt(e),pets:e==="zcode"?Pr():void 0});let N=0;for(const y of s)try{console.log(`[injector] Injecting to target ${y.id}: ${y.url}`);const C=new J(y.webSocketDebuggerUrl);if(await C.open(),e==="workbuddy"&&!await C.evaluate(`(() => {
          ...
          })()`)){console.warn(`[injector] Skipping non-WorkBuddy target ${y.id}: ${y.url}`),C.close();continue}if(e==="codex"){const S=await Rr();S&&await C.evaluate(`(() => {
          ...
          })()`,A=ce.get(y.id);A&&await C.removeScriptToEvaluateOnNewDocument(A).catch(()=>{});const R=await C.addScriptToEvaluateOnNewDocument(S);R&&ce.set(y.id,R)}const O=await C.evaluate(e==="hana-agent"?`(() => { window.__dreamWorkForceApply = true; return ${_}; })()`:_);if(console.log(`[injector] Injection result for target ${y.id}:`,O),e==="zcode"){const S=ur(),A=fe.get(y.id);A&&await C.removeScriptToEvaluateOnNewDocument(A).catch(()=>{});const R=await C.addScriptToEvaluateOnNewDocument(`(() => { const inject = () => { ${S} }; if (document.readyState === 'loading') window.addEventListener('DOMContentLoaded', inject, { once: true }); else inject(); })()`).catch(()=>{});R&&fe.set(y.id,R),await C.evaluate(S).catch(q=>console.warn(`[injector] Usage bar injection failed for target ${y.id}:`,q.message))}if(e==="hana-agent"){let S=!1;for(let A=0;A<20&&(S=await C.evaluate(`(() => {
            ...
            })()`).catch(()=>!1),!S);A++)await new Promise(R=>setTimeout(R,100));if(!S){console.warn(`[injector] HanaAgent injection did not become ready for target ${y.id}`),C.close();continue}}if(e==="codex")for(let S=1;S<=4;S++){const A=await C.evaluate(`(() => {
            ...
            })`);if(A.homeClasses&&A.homeClasses.includes("dream-skin-home")){console.log(`[injector] Codex home detection for ${y.id}: attempt=${S}`,JSON.stringify(A));break}S<4&&await new Promise(R=>setTimeout(R,800))}if(e==="codex")try{const S=await C.evaluate(`(() => {
            ...
            })()`);console.log(`[injector] Codex debug info for ${y.id}:`,JSON.stringify(S,null,2))}catch(S){console.error(`[injector] Failed to get debug info for ${y.id}:`,S)}C.close(),N++}catch(C){console.error(`[injector] Failed to inject to target ${y.id}:`,C)}if(e==="hana-agent"&&N>0){const y=new Set(s.map(A=>A.id)),C=Date.now()+2e4;let O="",S=0;for(;Date.now()<C;){let A=[];try{A=await me(t,".hanako/artifacts/renderer/",{timeoutMs:2e3,quiet:!0})}catch{}const R=A[0];if(!R){O="",S=0,await new Promise(V=>setTimeout(V,250));continue}if(!y.has(R.id)){console.log(`[injector] HanaAgent created renderer target ${R.id}; injecting theme`);const V=new J(R.webSocketDebuggerUrl);try{await V.open();const ye=`(() => {
              const inject = () => ${_};
              if (document.readyState === 'loading') window.addEventListener('DOMContentLoaded', inject, { once: true });
              else inject();
            })()`,te=await V.addScriptToEvaluateOnNewDocument(ye);te&&ce.set(R.id,te),await V.evaluate(`(() => { window.__dreamWorkForceApply = true; return ${_}; })()`),y.add(R.id)}finally{V.close()}}const q=new J(R.webSocketDebuggerUrl);let X=!1;try{await q.open(),X=await q.evaluate(`(() => {
            const host = document.getElementById('${H}-host');
            return Boolean(document.getElementById('${Z}') && host?.shadowRoot?.getElementById('${H}') && document.documentElement.dataset.dreamTheme);
          })()`)}catch{}finally{q.close()}if(X){if(O!==R.id)O=R.id,S=Date.now();else if(Date.now()-S>=2e3)return Dr(t,_,y),et(e,n),{success:!0,applied:1}}else O="",S=0;await new Promise(V=>setTimeout(V,250))}return{success:!1,applied:0,error:"HanaAgent renderer did not stabilize with the injected theme"}}return e==="zcode"&&N>0&&Xt(t),N>0&&et(e,n),{success:N>0,applied:N}}catch(i){return console.error("[injector] Injection failed:",i),{success:!1,applied:0,error:i.message}}}async function Ur(e,n,t={}){return Nr(e,n,t)}function Dr(e,n,t){const r=ge.get(e);r&&clearInterval(r);const a=(ee.get(e)??0)+1;ee.set(e,a);let o=!1;const s=setInterval(async()=>{if(!o&&ee.get(e)===a){o=!0;try{const i=(await me(e,".hanako/artifacts/renderer/",{timeoutMs:1e3,quiet:!0}))[0];if(!i||ee.get(e)!==a)return;const l=new J(i.webSocketDebuggerUrl);try{await l.open();const d=await l.evaluate(`(() => {
          const host = document.getElementById('${H}-host');
          if (document.documentElement.dataset.dreamThemeRestored === 'true') return 'restored';
          return document.getElementById('${Z}') && host?.shadowRoot?.getElementById('${H}') && document.documentElement.dataset.dreamTheme
            ? 'ready'
            : 'missing';
        })()`).catch(()=>"missing");if(d==="ready"||d==="restored"){t.add(i.id);return}if(console.log(`[injector] HanaAgent watcher restoring theme on renderer target ${i.id}`),ee.get(e)!==a)return;const p=`(() => {
          const inject = () => ${n};
          if (document.readyState === 'loading') window.addEventListener('DOMContentLoaded', inject, { once: true });
          else inject();
        })()`;if(!t.has(i.id)){const h=await l.addScriptToEvaluateOnNewDocument(p);h&&ce.set(i.id,h)}if(await l.evaluate(n),ee.get(e)!==a){await l.evaluate(`(() => {
          ...
          })()`).catch(()=>{});return}t.add(i.id)}finally{l.close()}}catch{await Or(e)||(clearInterval(s),ge.delete(e))}finally{o=!1}}},1e3);ge.set(e,s)}async function Or(e){try{return(await fetch(`http://127.0.0.1:${e}/json/version`,{signal:AbortSignal.timeout(500)})).ok}catch{return!1}}async function Nr(e,n,t={}){var c;const r=t.rendererUrlHint?[t.rendererUrlHint]:((c=W(e))==null?void 0:c.rendererHints)??["renderer/index.html","index.html"];let a=[];for(const i of r)try{if(a=await me(n,i,{timeoutMs:1e3,quiet:!0}),a.length>0)break}catch{}if(a.length===0)try{const l=await(await fetch(`http://127.0.0.1:${n}/json/list`,{signal:AbortSignal.timeout(5e3)})).json();a=(Array.isArray(l)?l:[]).filter(je).sort((d,p)=>{const h=[String(d.id??""),d.url,d.webSocketDebuggerUrl],g=[String(p.id??""),p.url,p.webSocketDebuggerUrl];for(let b=0;b<h.length;b++){if(h[b]<g[b])return-1;if(h[b]>g[b])return 1}return 0})}catch{}if(a.length===0)return{installed:!1,menu:!1,targets:0};const o=[];for(const i of a){const l=new J(i.webSocketDebuggerUrl);try{if(await l.open(),e==="workbuddy"&&!await l.evaluate("(() => document.body?.dataset.applicationName === 'workbuddy')()"))continue;const d=await l.evaluate(`(() => {
      ...
      })()`),p=JSON.parse(d);o.push(p)}catch(d){console.warn(`[injector] Status check failed for ${e} target ${i.id}:`,d)}finally{l.close()}}const s=o.find(i=>i.installed&&i.themeId)??o.find(i=>i.installed);return{installed:o.some(i=>i.installed),menu:o.some(i=>i.menu),themeId:s==null?void 0:s.themeId,targets:o.length}}async function Br(e,n,t={}){var o;if(e==="hana-agent"){ee.set(n,(ee.get(n)??0)+1);const s=ge.get(n);s&&clearInterval(s),ge.delete(n)}const r=t.rendererUrlHint??((o=W(e))==null?void 0:o.rendererHints[0])??"renderer/index.html";let a=[];try{a=await me(n,r)}catch{}if(a.length===0)try{const c=await(await fetch(`http://127.0.0.1:${n}/json/list`,{signal:AbortSignal.timeout(5e3)})).json();a=(Array.isArray(c)?c:[]).filter(je).sort((i,l)=>{const d=[String(i.id??""),i.url,i.webSocketDebuggerUrl],p=[String(l.id??""),l.url,l.webSocketDebuggerUrl];for(let h=0;h<d.length;h++){if(d[h]<p[h])return-1;if(d[h]>p[h])return 1}return 0})}catch{}if(a.length===0)return{success:!1};for(const s of e==="hana-agent"?a:a.slice(0,1)){const c=new J(s.webSocketDebuggerUrl);if(await c.open(),e==="hana-agent"){const i=ce.get(s.id);i&&(await c.removeScriptToEvaluateOnNewDocument(i).catch(()=>{}),ce.delete(s.id))}if(e==="zcode"){const i=fe.get(s.id);i&&(await c.removeScriptToEvaluateOnNewDocument(i).catch(()=>{}),fe.delete(s.id))}await c.evaluate(`(() => {
      ...
      return true;
    })`),c.close()}return e==="zcode"&&(fe.clear(),_r(n)),{success:!0}}const $t=.35;function jr(e,n,t,r){let a,o=.58;try{a=le(n),o=ct(le(e))[0]}catch{a=[12,12,18]}const s=t??a,c=r.map(p=>re(s,a,p)),i=p=>Math.min(...c.map(h=>ne(p,h))),l=we(o,$t,.9),d=we(o,$t,.15);return oe(i(l)>=i(d)?l:d)}function Lr(e,n,t,r){const a=le(e),o=r.map(c=>re(t??a,a,c)),s=Se(le(n),o,4.5);return{text:oe(s),textSubtle:oe(Se(re(a,s,.88),o,3)),textSubtlest:oe(Se(re(a,s,.8),o,3)),textSecondary:oe(Se(re(a,s,.72),o,3))}}function Wr(e){const n=e[0]/255,t=e[1]/255,r=e[2]/255,a=Math.max(n,t,r),o=Math.min(n,t,r),s=(a+o)/2,c=a-o,i=c===0?0:c/(1-Math.abs(2*s-1)),p=(((c===0?0:a===n?(t-r)/c%6:a===t?(r-n)/c+2:(n-t)/c+4)*60%360+360)%360-60+360)%360,h=(1-Math.abs(2*s-1))*Math.max(i,.35),g=h*(1-Math.abs(p/60%2-1)),b=s-h/2;return(p<60?[h,g,0]:p<120?[g,h,0]:p<180?[0,h,g]:p<240?[0,g,h]:p<300?[g,0,h]:[h,0,g]).map(_=>(_+b)*255)}function Et(e){let n;try{n=le(e)}catch{return null}const t=n[0]/255,r=n[1]/255,a=n[2]/255,o=Math.max(t,r,a),s=Math.min(t,r,a),c=o-s;let i=0;return c>0&&(i=((o===t?(r-a)/c%6:o===r?(a-t)/c+2:(t-r)/c+4)*60%360+360)%360),{h:i,chroma:c}}function Hr(e,n){const t=Et(e),r=Et(n);if(!t||!r)return n;const a=Math.abs(t.h-r.h)%360;return(a>180?360-a:a)>=45&&r.chroma>=.1?n:oe(Wr(le(e)))}function _t(e,n,t,r=null,a={}){var p,h,g,b;const o=((p=n.colors)==null?void 0:p.surface)??"#f7fbff",s=((h=n.colors)==null?void 0:h.text)??"#17344f",c=((g=n.colors)==null?void 0:g.accent)??"#24c9d7",i=a.template?{text:s,textSubtle:I.textSubtle,textSubtlest:I.textSubtlest,textSecondary:I.textSecondary}:Lr(o,a.video?jr(c,o,r,nt(e)):s,r,nt(e)),l={accent:c,secondary:((b=n.colors)==null?void 0:b.secondary)??"#ef8fd3",surface:o,...i};if(e==="zcode"&&!a.template&&(l.secondary=Hr(l.accent,l.secondary)),e==="codex")return Kr(n,t,l);const d=W(e);return(d==null?void 0:d.kind)==="vscode-work"?Fr(n,t,l):(d==null?void 0:d.kind)==="generic-work"?e==="hana-agent"?tn(n,t,l):zr(e,n,t,l,!!a.video):nn({...n,copy:null},t,l)}function Fr(e,n,t){return`/* DREAM_THEME:${e.id} */
:root {
...
}`}function tn(e,n,t){return`/* DREAM_THEME:${e.id} */
:root {
...
`}function Mt(e,n=""){return JSON.stringify(typeof e=="string"?e:n)}function nn(e,n,t){var a,o;return`/* DREAM_THEME:${String(e.id??"custom").replace(/[^a-z0-9_-]/gi,"")} */
...
#root::before {
  ...
  top: 60px;
  left: max(300px, 22vw);
  content: ${Mt((a=e.copy)==null?void 0:a.brand)};
  color: var(--wb-accent);
...
#root::after {
  ...
  left: max(300px, 22vw);
  max-width: 42vw;
  content: ${Mt((o=e.copy)==null?void 0:o.headline)};
  color: var(--wb-text);
  font: 750 clamp(18px, 2.7vw, 42px)/1.15 ui-rounded, system-ui;
  text-shadow: 0 2px 12px white;
  pointer-events: none;
}`}function Kr(e,n,t){const r=Zr(t.surface),a=r?`color-mix(in srgb, ${t.surface} 90%, transparent)`:`color-mix(in srgb, ${t.surface} 86%, transparent)`,o=r?`color-mix(in srgb, ${t.accent} 16%, ${t.surface})`:`color-mix(in srgb, ${t.accent} 42%, ${t.surface})`,s=r?"#172033":`color-mix(in srgb, ${t.surface} 72%, #000000)`,c="#f2f6ff",i=`/* DREAM_THEME:${e.id} */
...
`+l}function Zr(e){const n=/^#([0-9a-f]{6})$/i.exec(e);if(!n)return!0;const t=parseInt(n[1],16);return .299*(t>>16&255)+.587*(t>>8&255)+.114*(t&255)>140}function Xr(e){return`(() => {
  ...
  return true;
})()`}function Yr(e){const n=JSON.stringify(e.themes),t=JSON.stringify(e.cssTemplate??""),r=e.appId,a=e.surfaceAlphas??Yt;return`(() => {
  const themes = ${n};
  const cssTemplate = ${t};
  const sentinels = ${JSON.stringify(I)};
  ...
  ensureInjectedNodes();
})()`}function Qr(e){if(!/^[a-z0-9._-]+$/i.test(e.id||""))throw new Error(`Invalid shortcut id: ${e.id}`);if(!/^[a-z0-9-]+$/i.test(e.appId||""))throw new Error(`Invalid appId: ${e.appId}`);if(!/^[a-z0-9._-]+$/i.test(e.themeId||""))throw new Error(`Invalid themeId: ${e.themeId}`)}function dt(e){const n=e.replace(/[^\p{L}\p{N} ._-]/gu,"").trim();return n.length>0?n.slice(0,80):"DreamWorkTheme"}async function ea(e){try{return Qr(e),L.platform()==="win32"?ta(e):L.platform()==="darwin"?na(e):L.platform()==="linux"?ra(e):{success:!1,error:`Unsupported platform: ${L.platform()}`}}catch(n){return{success:!1,error:n.message}}}function ta(e){const n=m.join(L.homedir(),"Desktop"),t=m.join(n,`${dt(e.label)}.lnk`),r=process.execPath,a=m.dirname(r),o=`
    ...
    $Shortcut.Save()
  `;return new Promise(s=>{require("child_process").execFile("powershell.exe",["-NoProfile","-Command",o],c=>{s(c?{success:!1,error:c.message}:{success:!0,path:t})})})}function na(e){const n=m.join(L.homedir(),"Desktop"),t=m.join(n,`${dt(e.label)}.app`),a=`
    tell application "Terminal"
      do script "'${process.execPath}' --launch=${e.appId}:${e.themeId}"
    end tell
  `,o=m.join(n,`${e.id}.scpt`);return f.writeFileSync(o,a),new Promise(s=>{require("child_process").execFile("osacompile",["-o",t,o],c=>{f.unlinkSync(o),s(c?{success:!1,error:c.message}:{success:!0,path:t})})})}async function ra(e){const n=m.join(L.homedir(),".local","share","applications");f.existsSync(n)||f.mkdirSync(n,{recursive:!0});const t=m.join(n,`${e.id}.desktop`),r=process.execPath,a=`[Desktop Entry]
Type=Application
Name=${dt(e.label)}
...
Terminal=false
Categories=Utility;
`;return f.writeFileSync(t,a),f.chmodSync(t,493),{success:!0,path:t}}const aa=rt.promisify(Oe.execFile),oa="https://api.dreamskin.cc",rn=`${oa}/v1/themes`,an=32*1024*1024,De=6;let Ye=0;const sa=["workbuddy","codex","trae-work","qoder-work","catpaw","zcode","qwen-office","hana-agent"];async function ia(){const e=Ye,n=await ca(e),t=n.items;Ye=e+t.length>=n.total?0:e+De;const r=Ht(),a={checked:t.length,imported:0,skipped:0,offset:e,page:Math.floor(e/De)+1,total:n.total,nextOffset:Ye,failed:[]};for(const o of t){const s=pa(o.themeId);if(!o.applyCompatible||Ft(s)){a.skipped++;continue}try{await la(o,r,s)?a.imported++:a.skipped++}catch(c){a.failed.push({id:o.id,name:o.name,error:c.message})}}return a}async function ca(e){const n=`${rn}?limit=${De}&offset=${e}&sort=recent`,t=await fetch(n,{signal:AbortSignal.timeout(3e4),redirect:"error"});if(!t.ok)throw new Error(`Theme list request failed: HTTP ${t.status}`);const r=await t.json();if(!Array.isArray(r.items)||r.items.length>De||!Number.isInteger(r.total)||r.total<0)throw new Error("Theme list response is invalid");return{items:r.items,total:r.total}}async function la(e,n,t){ua(e);const r=f.mkdtempSync(m.join(L.tmpdir(),"dream-work-theme-")),a=m.join(r,"theme.zip"),o=m.join(r,"extract"),s=m.join(n,`.updating-${t}-${process.pid}`);try{f.mkdirSync(o);const c=`${rn}/${e.id}/download`,i=await fetch(c,{signal:AbortSignal.timeout(12e4),redirect:"error"});if(!i.ok)throw new Error(`Theme download failed: HTTP ${i.status}`);const l=Buffer.from(await i.arrayBuffer());if(l.length!==e.packageBytes)throw new Error(`Downloaded size mismatch: expected ${e.packageBytes}, got ${l.length}`);if(l.length>an)throw new Error("Theme package exceeds 32 MiB");if(at.createHash("sha256").update(l).digest("hex")!==e.packageSha256)throw new Error("Downloaded SHA-256 does not match metadata");f.writeFileSync(a,l,{flag:"wx"}),await da(a,o);const p=ma(o),h=JSON.parse(f.readFileSync(m.join(p,"theme.json"),"utf8")),g=h.image;if(typeof g!="string"||m.basename(g)!==g||!/\.(png|jpe?g|webp)$/i.test(g))throw new Error("Theme image name is invalid");const b=m.join(p,g),w=m.join(p,"theme.css");if(!f.existsSync(b)||!f.statSync(b).isFile())throw new Error("Theme image is missing");if(!f.existsSync(w)||!f.statSync(w).isFile())throw new Error("theme.css is missing");const _=ha(h,e,t,`hero${m.extname(g).toLowerCase()}`);return nr(_.name,_.author,b)?!1:(f.mkdirSync(s),f.copyFileSync(b,m.join(s,_.hero)),f.copyFileSync(w,m.join(s,"theme.css")),f.writeFileSync(m.join(s,"theme.json"),`${JSON.stringify(_,null,2)}
`),f.renameSync(s,m.join(n,t)),!0)}finally{f.rmSync(s,{recursive:!0,force:!0}),f.rmSync(r,{recursive:!0,force:!0})}}async function da(e,n){const{path7za:t}=require("7zip-bin");await aa(t,["x",e,`-o${n}`,"-y"],{windowsHide:!0,timeout:12e4})}function ma(e){const t=[e,...f.readdirSync(e,{withFileTypes:!0}).filter(r=>r.isDirectory()).map(r=>m.join(e,r.name))].filter(r=>f.existsSync(m.join(r,"theme.json"))&&f.existsSync(m.join(r,"theme.css")));if(t.length!==1)throw new Error("Theme ZIP must contain one theme root");return t[0]}function ua(e){if(!/^ver_[a-z0-9]{8,64}$/.test(e.id))throw new Error("Theme version ID is invalid");if(!Number.isInteger(e.packageBytes)||e.packageBytes<1||e.packageBytes>an)throw new Error("Theme package size is invalid");if(!/^[a-f0-9]{64}$/.test(e.packageSha256))throw new Error("Theme package SHA-256 is invalid")}function pa(e){return String(e).toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"").replace(/-+/g,"-")||"community-theme"}function ha(e,n,t,r){const a=e.appearance==="dark"?"dark":"light",o=a==="dark"?"#10141c":"#f4f7fa",s=e.colors||{};return{schemaVersion:1,id:t,name:String(e.name||n.name||t).trim(),author:n.authorDisplayName||"DreamSkin Community",hero:r,colors:{accent:he(s.accent,"#4f8cff",o),secondary:he(s.secondary||s.accentAlt,"#7ba7d8",o),surface:he(s.panelAlt||s.panel||s.background,o,o),text:he(s.text,a==="dark"?"#eef2f7":"#1f2937",o)},copy:null,apps:Object.fromEntries(sa.map(c=>[c,{compat:!0}]))}}function he(e,n,t){if(typeof e!="string")return n;const r=e.trim().match(/^#([0-9a-f]{3}|[0-9a-f]{6}|[0-9a-f]{8})$/i);if(r){let i=r[1];return i.length===3&&(i=i.split("").map(l=>l+l).join("")),`#${i.slice(0,6).toLowerCase()}`}const a=e.trim().match(/^rgba?\(\s*(\d{1,3})\s*,\s*(\d{1,3})\s*,\s*(\d{1,3})(?:\s*,\s*(0|1|0?\.\d+))?\s*\)$/i);if(!a)return n;const o=a[4]===void 0?1:Number(a[4]),s=he(t,n,n).slice(1).match(/../g).map(i=>parseInt(i,16));return`#${[1,2,3].map(i=>Math.round(Number(a[i])*o+s[i-1]*(1-o))).map(i=>i.toString(16).padStart(2,"0")).join("")}`}let be=null;var Rt;const It=((Rt=W("zcode"))==null?void 0:Rt.defaultPort)??9344;async function Pt(){try{if(Mr(It)||!await jt("zcode"))return;Xt(It),console.error("[main] usage pump ensured for zcode (passive start, 0.7.10)")}catch{}}P.app.whenReady().then(()=>{Pt(),setInterval(()=>void Pt(),1e4)});P.protocol.registerSchemesAsPrivileged([{scheme:"theme-asset",privileges:{standard:!0,secure:!0,supportFetchAPI:!0,stream:!0}}]);function on(){be=new P.BrowserWindow({width:1200,height:800,webPreferences:{preload:m.join(__dirname,"preload.js"),contextIsolation:!0,nodeIntegration:!1}}),process.env.VITE_DEV_SERVER_URL?be.loadURL(process.env.VITE_DEV_SERVER_URL):be.loadFile(m.join(__dirname,"../renderer/dist/index.html"))}P.app.whenReady().then(()=>{P.protocol.handle("theme-asset",e=>{const n=decodeURIComponent(new URL(e.url).pathname.replace(/^\//,"")),t=Qn(n);return t?new Response(f.readFileSync(t),{headers:{"Content-Type":ga(t),"Cache-Control":"public, max-age=3600"}}):new Response("Theme asset not found",{status:404})}),on()});function ga(e){const n=m.extname(e).toLowerCase();return n===".jpg"||n===".jpeg"?"image/jpeg":n===".webp"?"image/webp":"image/png"}P.app.on("window-all-closed",()=>{process.platform!=="darwin"&&P.app.quit()});P.app.on("activate",()=>{P.BrowserWindow.getAllWindows().length===0&&on()});const At=process.argv.find(e=>e.startsWith("--launch="));if(At){const[,e]=At.split("="),[n,t]=e.split(":");n&&t&&(console.log(`[main] Received launch args: ${n}:${t}`),setTimeout(async()=>{try{const r=await Lt(n,t);r.success?(console.log(`[main] Launched ${n} with theme ${t} on port ${r.port}`),setTimeout(async()=>{try{console.log(`[main] Starting theme injection for ${n}:${t} on port ${r.port}`);const a=await en(n,t,r.port);console.log("[main] Injection result:",a)}catch(a){console.error("[main] Failed to inject theme:",a)}},3e3)):console.error(`[main] Failed to launch ${n}: ${r.error}`)}catch(r){console.error("[main] Launch error:",r)}},1e3))}P.ipcMain.handle("discover-apps",async()=>In());P.ipcMain.handle("list-app-path-configurations",()=>yn());P.ipcMain.handle("choose-custom-app-path",async(e,n)=>{if(process.platform!=="win32")return{success:!1,error:"自定义应用路径目前仅支持 Windows。"};const t=W(n);if(!t)return{success:!1,error:`Unknown app: ${n}`};const r={title:`选择 ${t.name} 的可执行文件`,buttonLabel:"选择此文件",properties:["openFile"],filters:[{name:`${t.name} 可执行文件`,extensions:["exe"]}]},a=be?await P.dialog.showOpenDialog(be,r):await P.dialog.showOpenDialog(r);if(a.canceled||a.filePaths.length===0)return{success:!1,cancelled:!0};try{return{success:!0,path:kn(n,a.filePaths[0])}}catch(o){return{success:!1,error:(o==null?void 0:o.message)||String(o)}}});P.ipcMain.handle("clear-custom-app-path",(e,n)=>{try{return Cn(n),{success:!0}}catch(t){return{success:!1,error:(t==null?void 0:t.message)||String(t)}}});P.ipcMain.handle("launch-app",async(e,n,t)=>Lt(n,t));P.ipcMain.handle("apply-theme",async(e,n,t,r)=>en(n,t,r));P.ipcMain.handle("create-shortcut",async(e,n)=>{const t={...n,id:`${n.appId}-${n.themeId}-${Date.now()}`};return ea(t)});P.ipcMain.handle("list-themes",async(e,n)=>Le(n).map(t=>({id:t.id,name:t.name,author:t.author,hero:er(t.id)})));P.ipcMain.handle("update-themes",async()=>ia());P.ipcMain.handle("get-status",async(e,n,t)=>{var a;return await jt(n)?{...await Ur(n,t||((a=W(n))==null?void 0:a.defaultPort)||9339),running:!0}:{installed:!1,menu:!1,targets:0,running:!1}});P.ipcMain.handle("remove-skin",async(e,n,t)=>Br(n,t));P.ipcMain.handle("debug-targets",async(e,n)=>{try{const r=await(await fetch(`http://127.0.0.1:${n}/json/list`,{signal:AbortSignal.timeout(5e3)})).json();return{success:!0,count:r.length,raw:r,targets:r.map(a=>({id:a.id,type:a.type,url:a.url,title:a.title,webSocketDebuggerUrl:a.webSocketDebuggerUrl}))}}catch(t){return{success:!1,error:t.message}}});
