"use strict";var at=Object.defineProperty;var st=(e,r,t)=>r in e?at(e,r,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[r]=t;var S=(e,r,t)=>st(e,typeof r!="symbol"?r+"":r,t);const y=require("electron"),it=require("path"),ct=require("fs"),lt=require("os"),re=require("child_process"),he=require("util"),dt=require("http"),mt=require("net"),ut=require("fs/promises"),pt=require("crypto"),ht=require("zlib");function W(e){const r=Object.create(null,{[Symbol.toStringTag]:{value:"Module"}});if(e){for(const t in e)if(t!=="default"){const n=Object.getOwnPropertyDescriptor(e,t);Object.defineProperty(r,t,n.get?n:{enumerable:!0,get:()=>e[t]})}}return r.default=e,Object.freeze(r)}const d=W(it),u=W(ct),E=W(lt),je=W(dt),Re=W(mt),ge=W(pt),_=process.env.LOCALAPPDATA||d.join(E.homedir(),"AppData","Local"),$e=process.env.APPDATA||d.join(E.homedir(),"AppData","Roaming"),R=process.env.ProgramFiles||"C:\\Program Files",se=process.env["ProgramFiles(x86)"]||"C:\\Program Files (x86)",fe=[{id:"workbuddy",name:"WorkBuddy",exeNames:["WorkBuddy.exe"],processName:"WorkBuddy.exe",defaultPort:9339,installPaths:[d.join(_,"workbuddy"),d.join(_,"Programs","workbuddy"),d.join(R,"WorkBuddy"),d.join(se,"WorkBuddy"),"D:\\Program Files\\WorkBuddy"],rendererHints:["app.asar/renderer/index.html","renderer/index.html","index.html"],kind:"workbuddy"},{id:"codex",name:"Codex",exeNames:["ChatGPT.exe","Codex.exe"],processName:"ChatGPT.exe",defaultPort:9340,installPaths:[d.join(_,"Programs","Codex"),d.join(_,"Programs","OpenAI","Codex"),d.join(R,"Codex"),d.join(se,"Codex"),"D:\\Program Files\\Codex"],rendererHints:["index.html","renderer/index.html"],kind:"codex"},{id:"trae-work",name:"TRAE Work",exeNames:["TRAE SOLO CN.exe","TRAE Work CN.exe"],processName:"TRAE SOLO CN.exe",defaultPort:9341,installPaths:["D:\\Program Files\\TRAE SOLO CN",d.join(_,"Programs","TRAE SOLO CN"),d.join(R,"TRAE SOLO CN")],rendererHints:["solo/solo-lite.html","solo-lite.html"],kind:"vscode-work"},{id:"qoder-work",name:"QoderWork",exeNames:["QoderWork CN.exe","QoderWork.exe"],processName:"QoderWork CN.exe",defaultPort:9342,installPaths:["D:\\Program Files\\QoderWork CN",d.join(_,"Programs","QoderWork CN"),d.join(R,"QoderWork CN")],rendererHints:["out/renderer/index.html","renderer/index.html"],kind:"generic-work",devToolsActivePort:d.join($e,"QoderWork CN","DevToolsActivePort")},{id:"catpaw",name:"CatPaw",exeNames:["CatPaw.exe"],processName:"CatPaw.exe",defaultPort:9343,installPaths:[d.join(_,"CatPaw"),d.join(_,"Programs","CatPaw"),d.join(R,"CatPaw")],rendererHints:["app.asar/dist/index.html","dist/index.html"],kind:"generic-work"},{id:"zcode",name:"ZCode",exeNames:["ZCode.exe"],processName:"ZCode.exe",defaultPort:9344,installPaths:["D:\\Program Files\\ZCode",d.join(_,"Programs","ZCode"),d.join(R,"ZCode")],rendererHints:["out/renderer/index.html","renderer/index.html"],kind:"generic-work"},{id:"qwen-office",name:"千问办公",exeNames:["QwenWorkCN.exe"],processName:"QwenWorkCN.exe",defaultPort:9345,installPaths:["D:\\Program Files\\QwenWorkCN",d.join(_,"Programs","QwenWorkCN"),d.join(R,"QwenWorkCN")],rendererHints:["out/renderer/index.html","renderer/index.html"],kind:"generic-work",devToolsActivePort:d.join($e,"QwenWorkCN","DevToolsActivePort")},{id:"hana-agent",name:"HanaAgent",exeNames:["HanaAgent.exe"],processName:"HanaAgent.exe",defaultPort:9346,installPaths:[d.join(_,"Programs","HanaAgent"),d.join(R,"HanaAgent"),d.join(se,"HanaAgent")],rendererHints:[".hanako/artifacts/renderer/","artifacts/renderer/","/index.html"],kind:"generic-work"}];function M(e){return fe.find(r=>r.id===e)}const Q=1;function gt(){const e=ne().paths;return fe.map(r=>{const t=e[r.id];return{appId:r.id,name:r.name,exeNames:[...r.exeNames],customPath:t,customPathStatus:t?be(r.id,t)?"valid":"invalid":"none"}})}function ft(e){const r=ne().paths[e];return r&&be(e,r)?r:void 0}function bt(e,r){const t=M(e);if(!t)throw new Error(`Unknown app: ${e}`);if(!be(e,r))throw new Error(`请选择 ${t.name} 的可执行文件（${t.exeNames.join(" 或 ")}）`);const n=ne();return n.paths[e]=d.resolve(r),Ue(n),n.paths[e]}function xt(e){if(!M(e))throw new Error(`Unknown app: ${e}`);const r=ne();delete r.paths[e],Ue(r)}function be(e,r){const t=M(e);if(!t||!r||typeof r!="string")return!1;try{if(!u.statSync(r).isFile())return!1}catch{return!1}const n=d.basename(r).toLowerCase();return t.exeNames.some(o=>o.toLowerCase()===n)}function Oe(){return d.join(y.app.getPath("userData"),"app-paths.json")}function ne(){try{const e=JSON.parse(u.readFileSync(Oe(),"utf8"));if(!e||typeof e!="object"||Array.isArray(e))return ie();const r=e;if(r.version!==Q||!r.paths||typeof r.paths!="object"||Array.isArray(r.paths))return ie();const t={};for(const[n,o]of Object.entries(r.paths))M(n)&&typeof o=="string"&&o.trim()&&(t[n]=o);return{version:Q,paths:t}}catch{return ie()}}function ie(){return{version:Q,paths:{}}}function Ue(e){const r=Oe();u.mkdirSync(d.dirname(r),{recursive:!0}),u.writeFileSync(r,`${JSON.stringify({version:Q,paths:e.paths},null,2)}
`,"utf8")}const wt=he.promisify(re.execFile);async function Ne(e){const r=M(e);if(!r)return null;const t=ft(e);if(t)return t;const n=yt(r.exeNames,r.installPaths);if(n)return n;const o=kt(r);if(o)return o;if(e==="codex"){const a=vt();return a||Ct()}return null}function yt(e,r){for(const t of r)if(!(!t||!u.existsSync(t)))try{if(u.statSync(t).isFile()&&$t(t,e))return t;for(const o of e){const a=d.join(t,o);if(K(a))return a}const n=u.readdirSync(t,{withFileTypes:!0}).filter(o=>o.isDirectory()).sort((o,a)=>a.name.localeCompare(o.name,void 0,{numeric:!0}));for(const o of n)for(const a of e){const s=d.join(t,o.name,a);if(K(s))return s}}catch{}return null}function kt(e){const r=[process.env.ProgramFiles,process.env["ProgramFiles(x86)"]].filter(t=>!!t);for(const t of r)if(u.existsSync(t))try{const n=u.readdirSync(t).find(o=>o.toLowerCase().includes(e.id.replace("-",""))||o.toLowerCase().includes(e.name.toLowerCase()));if(!n)continue;for(const o of e.exeNames){const a=d.join(t,n,o);if(K(a))return a}}catch{}return null}function vt(){const e=d.join(process.env.ProgramFiles||"C:\\Program Files","WindowsApps");if(!u.existsSync(e))return null;try{for(const r of u.readdirSync(e)){if(!/^OpenAI\.Codex_\d+/i.test(r))continue;const t=d.join(e,r,"app","ChatGPT.exe");if(K(t))return t}}catch{}return null}async function Ct(){const e=`
...
`;try{const{stdout:r}=await wt("powershell.exe",["-NoLogo","-NoProfile","-NonInteractive","-ExecutionPolicy","Bypass","-Command",e],{encoding:"utf8",maxBuffer:4194304}),t=r.trim();return K(t)?t:null}catch{return null}}function $t(e,r){const t=d.basename(e).toLowerCase();return r.some(n=>n.toLowerCase()===t)}function K(e){try{return u.statSync(e).isFile()}catch{return!1}}async function St(){if(E.platform()!=="win32")return[];const e=[];for(const r of fe){const t=await Ne(r.id);t&&e.push({appId:r.id,name:r.name,path:t})}return e}const Se=he.promisify(re.execFile);async function Tt(e){const r=M(e);if(!r)return!1;const t=[...new Set([r.processName,...r.exeNames].filter(Boolean))];if(E.platform()==="win32"){for(const n of t)try{const{stdout:o}=await Se("tasklist.exe",["/FI",`IMAGENAME eq ${n}`,"/FO","CSV","/NH"],{encoding:"utf8",windowsHide:!0});if(o.split(/\r?\n/).some(a=>a.trim().toLowerCase().startsWith(`"${n.toLowerCase()}"`)))return!0}catch{}return!1}for(const n of t)try{return await Se("pgrep",["-f",n],{encoding:"utf8"}),!0}catch{}return!1}async function Le(e,r){if(!/^[a-z0-9-]+$/i.test(e||""))return{success:!1,error:`Invalid appId: ${e}`};if(r!=null&&!/^[a-z0-9._-]+$/i.test(r))return{success:!1,error:`Invalid themeId: ${r}`};const t=M(e);if(!t)return{success:!1,error:`Unknown app: ${e}`};const n=t.defaultPort,o=[`--remote-debugging-port=${n}`];e==="codex"&&o.push("--disable-extensions"),r&&o.push(`--dream-theme=${r}`);try{const a=await Rt(e);if(!a||!u.existsSync(a)||!u.statSync(a).isFile())return{success:!1,error:`Executable not found: ${a}`};if(E.platform()==="win32"&&!/\.exe$/i.test(a))return{success:!1,error:`Refusing to launch non-executable path: ${a}`};if(console.log(`[launcher] Killing existing ${e} instances...`),await Dt(e),await jt(n,15e3),t.devToolsActivePort)try{u.unlinkSync(t.devToolsActivePort)}catch{}console.log(`[launcher] Launching ${a} with args: ${o.join(" ")}`);const s=re.spawn(a,o,{detached:!0,stdio:"ignore",env:Et()});s.unref(),console.log(`[launcher] Spawned process with PID: ${s.pid}`),console.log(`[launcher] Waiting for CDP port ${n} to be ready...`);let c=n;return t.devToolsActivePort?c=await It(t.devToolsActivePort,t.rendererHints,3e4):await At(n,3e4),console.log(`[launcher] CDP port ${c} is ready`),e==="hana-agent"&&await Pt(c,t.rendererHints,3e4),{success:!0,port:c}}catch(a){return console.error("[launcher] Launch failed:",a),{success:!1,error:a.message}}}function Et(){const e={...process.env};for(const r of["VITE_DEV_SERVER_URL","ELECTRON_RENDERER_URL","MAIN_VITE_DEV_SERVER_URL","ELECTRON_RUN_AS_NODE"])delete e[r];return e}async function It(e,r,t){const n=Date.now();let o=0;for(;Date.now()-n<t;){try{const a=u.readFileSync(e,"utf8").split(/\r?\n/,1)[0],s=Number(a);if(Number.isInteger(s)&&s>0)return o=s,await Mt(s,r,3e3),s}catch{}await new Promise(a=>setTimeout(a,500))}throw new Error(`DevToolsActivePort did not expose a live renderer${o?` on port ${o}`:""}: ${e}`)}async function Mt(e,r,t){const n=Date.now();for(;Date.now()-n<t;){try{const o=await fetch(`http://127.0.0.1:${e}/json/list`,{signal:AbortSignal.timeout(1e3)});if(o.ok){const a=await o.json();if(Array.isArray(a)&&a.some(s=>(s==null?void 0:s.type)==="page"&&r.some(c=>String(s.url).includes(c))))return}}catch{}await new Promise(o=>setTimeout(o,250))}throw new Error(`CDP renderer endpoint is not ready on port ${e}`)}async function Pt(e,r,t){const n=Date.now();let o="",a=0;for(;Date.now()-n<t;){try{const i=(await(await fetch(`http://127.0.0.1:${e}/json/list`,{signal:AbortSignal.timeout(1e3)})).json()).find(l=>(l==null?void 0:l.type)==="page"&&r.some(p=>String(l.url).includes(p)));if(i!=null&&i.id){if(i.id!==o)o=i.id,a=Date.now();else if(Date.now()-a>=3e3){console.log(`[launcher] Stable HanaAgent renderer ${o} confirmed`);return}}}catch{}await new Promise(s=>setTimeout(s,250))}throw new Error(`HanaAgent renderer did not stabilize on port ${e}`)}async function At(e,r){const t=Date.now();let n="unknown";for(;Date.now()-t<r;)try{await new Promise((o,a)=>{const s=Re.createConnection(e,"127.0.0.1",()=>{s.end(),o()});s.once("error",c=>{n=c.message,a(c)}),setTimeout(()=>{s.destroy(),a(new Error("timeout"))},1e3)}),console.log(`[launcher] Port ${e} is open, verifying CDP endpoint...`),await _t(e,15e3),console.log(`[launcher] CDP endpoint verified on port ${e}`);return}catch(o){n=o.message,console.log(`[launcher] Port check failed: ${o.message}, retrying...`),await new Promise(a=>setTimeout(a,1e3))}throw new Error(`CDP port ${e} did not become ready within ${r}ms (last error: ${n})`)}async function _t(e,r){const t=Date.now();for(;Date.now()-t<r;)try{await new Promise((n,o)=>{const a=je.request({hostname:"127.0.0.1",port:e,path:"/json/version",method:"GET",timeout:2e3},s=>{let c="";s.on("data",i=>{c+=i}),s.on("end",()=>{s.statusCode===200?(console.log(`[launcher] CDP version response: ${c.substring(0,200)}`),n()):o(new Error(`HTTP ${s.statusCode}`))})});a.on("error",o),a.on("timeout",()=>{a.destroy(),o(new Error("timeout"))}),a.end()});return}catch(n){if(Date.now()-t>=r)throw n;await new Promise(o=>setTimeout(o,1e3))}}async function Dt(e){const r=E.platform(),t=M(e);if(!t)return;const n=[...new Set([t.processName,...t.exeNames].filter(Boolean))];try{if(r==="win32"){const{spawnSync:o}=require("child_process");for(const a of n)try{o("taskkill",["/T","/F","/IM",a],{stdio:"ignore"}),console.log(`[launcher] Killed existing ${a} process tree`)}catch{}}else if(r==="darwin"){const{spawnSync:o}=require("child_process");for(const a of n)try{o("pkill",["-f",a],{stdio:"ignore"}),console.log(`[launcher] Killed existing ${a} processes`)}catch{}}else if(r==="linux"){const{spawnSync:o}=require("child_process");for(const a of n)try{o("pkill",["-f",a],{stdio:"ignore"}),console.log(`[launcher] Killed existing ${a} processes`)}catch{}}}catch(o){console.warn("[launcher] Failed to kill existing instances:",o)}}async function jt(e,r){const t=Date.now();for(;Date.now()-t<r;){if(!await new Promise(o=>{const a=Re.createConnection(e,"127.0.0.1");a.once("connect",()=>{a.destroy(),o(!0)}),a.once("error",()=>o(!1)),a.setTimeout(500,()=>{a.destroy(),o(!1)})})){console.log(`[launcher] Previous CDP port ${e} is closed`);return}await new Promise(o=>setTimeout(o,250))}throw new Error(`Existing ${e} CDP service did not stop; refusing to inject into the old application instance`)}async function Rt(e){if(!M(e))throw new Error(`Unknown app: ${e}`);const t=E.platform();if(t==="win32"){const n=await Ne(e);if(n)return n}else if(t==="darwin"){const n=["/Applications/WorkBuddy.app","/Applications/ChatGPT.app"];for(const o of n)if(u.existsSync(o))return o}else if(t==="linux"){const n=e==="workbuddy"?["workbuddy","WorkBuddy"]:["codex","Codex"],o=["/usr/bin","/usr/local/bin","/opt",d.join(E.homedir(),".local","bin"),"/snap/bin"];for(const a of o)if(u.existsSync(a))for(const s of n){const c=d.join(a,s);if(u.existsSync(c))return c}for(const a of n)try{const{spawnSync:s}=require("child_process"),c=s("which",[a],{encoding:"utf8"}),i=String(c.stdout||"").trim();if(i&&u.existsSync(i))return i}catch{}}throw new Error(`Could not find ${e} executable`)}const Ot=5e3,Ut=100,Nt=15e3,Lt=1e4,Bt=5e3;function Ht(e){if(!Number.isInteger(e)||e<1024||e>65535)throw new TypeError("port must be an integer from 1024 through 65535");return e}function B(e,r,t={}){const n=t.allowZero?0:Number.EPSILON;if(!Number.isFinite(e)||e<n){const o=t.allowZero?"non-negative":"positive";throw new TypeError(`${r} must be a finite ${o} number`)}return e}function Be(e){if(typeof e!="string"||e.length===0||e!==e.trim())throw new TypeError("webSocketDebuggerUrl must be a non-empty URL string");let r;try{r=new URL(e)}catch(t){throw new TypeError(`webSocketDebuggerUrl is invalid: ${t.message}`)}if(r.protocol!=="ws:"||r.hostname!=="127.0.0.1"||r.username||r.password||r.hash||!r.port)throw new TypeError("webSocketDebuggerUrl must use ws://127.0.0.1 with an explicit port");return Ht(Number(r.port)),r}function Wt(e,r){if(e===null||typeof e!="object"||Array.isArray(e)||e.type!=="page"||typeof e.url!="string"||typeof e.webSocketDebuggerUrl!="string")return!1;try{Be(e.webSocketDebuggerUrl)}catch{return!1}return e.url.includes(r)}function xe(e){if(e===null||typeof e!="object"||Array.isArray(e)||e.type!=="page"||typeof e.url!="string"||typeof e.webSocketDebuggerUrl!="string")return!1;try{return Be(e.webSocketDebuggerUrl),!0}catch{return!1}}function Ft(e){return new Promise(r=>setTimeout(r,e))}async function Te(e,r){const t=Math.max(0,r.deadline-Date.now());let n=null;try{return await Promise.race([e,new Promise((o,a)=>{n=setTimeout(()=>{var s;(s=r.onTimeout)==null||s.call(r),a(new Error(`${r.label} timed out after ${r.timeoutMs}ms`))},t)})])}finally{n&&clearTimeout(n)}}async function G(e,r,t={}){const n=B(t.timeoutMs??Bt,"timeoutMs",{allowZero:!1}),o=t.fetchImpl??globalThis.fetch;if(typeof o!="function")throw new TypeError("fetchImpl must be a function");const a=`http://127.0.0.1:${e}/json/list`,s=new AbortController,c=Date.now()+n,i=t.quiet===!0;i||console.log(`[cdp] fetchRendererTargets: port=${e}, timeoutMs=${n}, endpoint=${a}`);let l;try{l=await Te(Promise.resolve(o(a,{redirect:"error",signal:s.signal})),{deadline:c,timeoutMs:n,label:"renderer target discovery",onTimeout:()=>s.abort()})}catch(m){throw i||console.log("[cdp] fetchRendererTargets error:",m),new Error(`failed to fetch renderer targets from ${a}: ${m.message}`)}if(l===null||typeof l!="object"||!l.ok)throw new Error(`renderer target discovery failed with HTTP ${(l==null?void 0:l.status)??"unknown"}`);let p;try{p=await Te(Promise.resolve(l.json()),{deadline:c,timeoutMs:n,label:"renderer target discovery JSON",onTimeout:()=>s.abort()})}catch(m){throw new Error(`malformed renderer target JSON from ${a}: ${m.message}`)}if(!Array.isArray(p))throw new Error("malformed renderer target JSON: expected an array");return p.filter(m=>Wt(m,r)).sort(qt)}async function zt(e,r,t={}){const n=B(t.timeoutMs??Ot,"timeoutMs",{allowZero:!0}),o=B(t.pollMs??Ut,"pollMs",{allowZero:!1}),a=t.fetchImpl??globalThis.fetch;let s=0;const c=Date.now()+n;let i=new Error("no renderer discovery attempt completed");for(console.log(`[cdp] waitForRendererTargets: port=${e}, hint=${r}, timeoutMs=${n}`);;){try{const p=Math.max(1,Math.min(n-s,c-Date.now()));console.log(`[cdp] Attempting fetch: elapsed=${s}ms, remainingBudget=${p}ms, deadline=${c}`);const m=await G(e,r,{fetchImpl:a,timeoutMs:p});if(m.length>0)return m;i=new Error("no matching renderer/index.html page targets")}catch(p){i=p instanceof Error?p:new Error(String(p)),console.log("[cdp] Fetch error:",i.message)}if(s>=n||Date.now()>=c)throw new Error(`timed out after ${n}ms waiting for renderer targets on 127.0.0.1:${e}: ${i.message}`);const l=Math.min(o,n-s);await Ft(l),s+=l}}class U{constructor(r,t={}){S(this,"webSocketDebuggerUrl");S(this,"WebSocketImpl");S(this,"commandTimeoutMs");S(this,"connectTimeoutMs");S(this,"socket",null);S(this,"nextRequestId",1);S(this,"pending",new Map);S(this,"socketOpen",!1);S(this,"opened",!1);S(this,"closed",!1);S(this,"closeStarted",!1);S(this,"terminalError",null);S(this,"openPromise",null);S(this,"resolveOpen",null);S(this,"rejectOpen",null);S(this,"connectTimer",null);this.webSocketDebuggerUrl=r;let n=null,o=null;try{n=require("ws")??null,n||(o="ws loaded but WebSocket is undefined")}catch(a){o=`ws require failed: ${(a==null?void 0:a.message)??a}`}if(!n)try{const a=require("undici");n=(a==null?void 0:a.WebSocket)??null,n||(o="undici loaded but WebSocket is undefined")}catch(a){o=`undici require failed: ${(a==null?void 0:a.message)??a}`}if(!n&&typeof globalThis.WebSocket=="function"&&(n=globalThis.WebSocket,o=null),!n){const a=o?` (${o})`:"";throw new Error(`No WebSocket implementation available for CDP${a}`)}this.WebSocketImpl=t.WebSocketImpl??n,this.commandTimeoutMs=B(t.commandTimeoutMs??Nt,"commandTimeoutMs"),this.connectTimeoutMs=B(t.connectTimeoutMs??Lt,"connectTimeoutMs")}open(){if(this.closed)return Promise.reject(this.terminalError??new Error("CDP session is closed"));if(this.opened)return Promise.resolve(this);if(this.openPromise)return this.openPromise;this.openPromise=new Promise((t,n)=>{this.resolveOpen=t,this.rejectOpen=n}),this.connectTimer=setTimeout(()=>{this.terminate(new Error(`CDP WebSocket connect timed out after ${this.connectTimeoutMs}ms`)),this.closeSocket()},this.connectTimeoutMs);try{this.socket=new this.WebSocketImpl(this.webSocketDebuggerUrl)}catch(t){return this.terminate(new Error(`failed to open CDP WebSocket: ${t.message}`)),this.openPromise}const r=this.socket;return r.onopen=()=>{this.closed||this.socketOpen||(this.clearConnectTimer(),this.socketOpen=!0,Promise.all([this.send("Runtime.enable"),this.send("Page.enable")]).then(()=>{if(this.closed)return;this.opened=!0;const t=this.resolveOpen;this.resolveOpen=null,this.rejectOpen=null,t==null||t(this)}).catch(t=>{this.terminate(t),this.closeSocket()}))},r.onmessage=t=>this.handleMessage(t),r.onerror=t=>{const n=t.error,o=n instanceof Error?n.message:typeof t.message=="string"&&t.message.length>0?t.message:"unknown socket error";this.terminate(new Error(`CDP WebSocket error: ${o}`)),this.closeSocket()},r.onclose=()=>{this.closeStarted=!0,this.terminate(new Error("CDP WebSocket closed"))},this.openPromise}send(r,t={},n={}){if(this.closed)return Promise.reject(this.terminalError??new Error("CDP session is closed"));if(!this.socketOpen||!this.socket)return Promise.reject(new Error("CDP session is not open"));if(typeof r!="string"||r.length===0)return Promise.reject(new TypeError("CDP method must be a non-empty string"));const o=B(n.timeoutMs??this.commandTimeoutMs,"timeoutMs"),a=this.nextRequestId++;return new Promise((s,c)=>{const i=setTimeout(()=>{this.pending.delete(a),c(new Error(`CDP ${r} timed out after ${o}ms`))},o);this.pending.set(a,{resolve:s,reject:c,timer:i});try{this.socket.send(JSON.stringify({id:a,method:r,params:t}))}catch(l){clearTimeout(i),this.pending.delete(a),c(new Error(`failed to send CDP ${r}: ${l.message}`))}})}async evaluate(r,t={}){var o,a,s;if(typeof r!="string")throw new TypeError("Runtime.evaluate expression must be a string");const n=await this.send("Runtime.evaluate",{expression:r,awaitPromise:!0,returnByValue:!0},t);if(n!=null&&n.exceptionDetails)throw new Error(`Runtime.evaluate failed: ${((o=n.exceptionDetails.exception)==null?void 0:o.description)??n.exceptionDetails.text??"unknown JavaScript exception"}`);if(((a=n==null?void 0:n.result)==null?void 0:a.type)!=="undefined")return(s=n==null?void 0:n.result)==null?void 0:s.value}async addScriptToEvaluateOnNewDocument(r){const t=await this.send("Page.addScriptToEvaluateOnNewDocument",{source:r});return t==null?void 0:t.identifier}async removeScriptToEvaluateOnNewDocument(r){await this.send("Page.removeScriptToEvaluateOnNewDocument",{identifier:r})}close(){this.closeStarted||(this.terminate(new Error("CDP session closed by client")),this.closeSocket())}handleMessage(r){if(typeof r.data!="string"){this.terminate(new Error("received a non-text CDP WebSocket message")),this.closeSocket();return}let t;try{t=JSON.parse(r.data)}catch(o){this.terminate(new Error(`received malformed CDP JSON: ${o.message}`)),this.closeSocket();return}if(!Number.isInteger(t==null?void 0:t.id))return;const n=this.pending.get(t.id);if(n){if(this.pending.delete(t.id),clearTimeout(n.timer),t.error){n.reject(new Error(`CDP error: ${t.error.message}`));return}n.resolve(t.result)}}terminate(r){if(this.terminalError)return;this.clearConnectTimer(),this.terminalError=r,this.closed=!0,this.socketOpen=!1;const t=this.rejectOpen;this.resolveOpen=null,this.rejectOpen=null,t==null||t(r);for(const{reject:n,timer:o}of this.pending.values())clearTimeout(o),n(r);this.pending.clear()}clearConnectTimer(){this.connectTimer!==null&&(clearTimeout(this.connectTimer),this.connectTimer=null)}closeSocket(){if(this.closeStarted||(this.closeStarted=!0,!this.socket||typeof this.socket.close!="function"))return;const r=this.WebSocketImpl.CLOSING??2,t=this.WebSocketImpl.CLOSED??3;this.socket.readyState===r||this.socket.readyState===t||this.socket.close()}}function qt(e,r){const t=[String(e.id??""),e.url,e.webSocketDebuggerUrl],n=[String(r.id??""),r.url,r.webSocketDebuggerUrl];for(let o=0;o<t.length;o++){if(t[o]<n[o])return-1;if(t[o]>n[o])return 1}return 0}function Jt(){return d.join(y.app.getAppPath(),"themes")}function He(){const e=d.join(y.app.getPath("userData"),"themes");return u.mkdirSync(e,{recursive:!0}),e}function Kt(){return[He(),Jt()]}const Ee=new Map;function oe(e){var o;const r=[],t=new Set;for(const a of Kt()){if(!u.existsSync(a))continue;const s=u.readdirSync(a,{withFileTypes:!0});for(const c of s){if(!c.isDirectory())continue;const i=d.join(a,c.name),l=d.join(i,"theme.json");if(u.existsSync(l))try{const p=JSON.parse(u.readFileSync(l,"utf-8")),m=Yt(p);if(t.has(m.id))continue;const h=d.join(i,m.hero);if(!u.existsSync(h)||!u.statSync(h).isFile())throw new Error(`theme hero is missing: ${m.hero}`);if(e&&((o=m.apps[e])==null?void 0:o.compat)!==!0&&e!=="hana-agent")continue;t.add(m.id),r.push({id:m.id,name:m.name,author:m.author,path:i,manifest:m})}catch(p){console.error(`Failed to load theme ${c.name}:`,p)}}}const n=new Map;for(const a of r){const s=d.join(a.path,a.manifest.hero),c=me(s),i=`${a.name.trim().toLocaleLowerCase()}\0${a.author.trim().toLocaleLowerCase()}\0${c}`,l=n.get(i);(!l||Gt(a.id,l.id))&&n.set(i,a)}return[...n.values()].sort((a,s)=>a.name.localeCompare(s.name))}function me(e){const r=u.statSync(e),t=Ee.get(e);if(t&&t.size===r.size&&t.mtimeMs===r.mtimeMs)return t.hash;const n=ge.createHash("sha256").update(u.readFileSync(e)).digest("hex");return Ee.set(e,{size:r.size,mtimeMs:r.mtimeMs,hash:n}),n}function Gt(e,r){const t=e.startsWith("custom-"),n=r.startsWith("custom-");return t!==n?!t:e.length<r.length||e.length===r.length&&e.localeCompare(r)<0}function We(e,r){return oe(r).find(t=>t.id===e)}function Vt(e){const r=We(e);if(!r)return;const t=d.resolve(r.path,r.manifest.hero);if(t.startsWith(`${d.resolve(r.path)}${d.sep}`))return t}function Xt(e){return`theme-asset://local/${encodeURIComponent(e)}`}function Zt(e){const r=d.resolve(e.path),t=d.resolve(r,e.manifest.hero);if(t!==r&&!t.startsWith(r+d.sep))throw new Error(`Theme hero path escapes theme directory: ${e.manifest.hero}`);const n=u.readFileSync(t);return`data:${er(e.manifest.hero)};base64,${n.toString("base64")}`}function Qt(e,r,t){const n=me(t);return oe().some(o=>o.name.trim().toLowerCase()!==e.trim().toLowerCase()||o.author.trim().toLowerCase()!==r.trim().toLowerCase()?!1:me(d.join(o.path,o.manifest.hero))===n)}function Yt(e){if(typeof e!="object"||e===null||Array.isArray(e))throw new Error("theme manifest must be an object");if(e.schemaVersion!==1)throw new Error(`unsupported theme schema ${e.schemaVersion}`);if(typeof e.id!="string"||!/^[a-z0-9-]+$/.test(e.id))throw new Error("theme id must use lowercase letters, numbers, and hyphens");if(typeof e.name!="string"||!e.name.trim())throw new Error("theme name must be a non-empty string");if(typeof e.author!="string")throw new Error("theme author must be a string");if(typeof e.hero!="string")throw new Error("theme hero must be a string");if(typeof e.colors!="object"||e.colors===null)throw new Error("theme colors must be an object");const r=["accent","secondary","surface","text"];for(const t of r)if(typeof e.colors[t]!="string"||!/^#[0-9a-fA-F]{6}$/.test(e.colors[t]))throw new Error(`theme color ${t} must be a hex color`);return{schemaVersion:1,id:e.id,name:e.name.trim(),author:e.author,hero:e.hero,colors:{accent:e.colors.accent,secondary:e.colors.secondary,surface:e.colors.surface,text:e.colors.text},copy:e.copy??void 0,apps:e.apps??{}}}function er(e){const r=d.extname(e).toLowerCase();return{".png":"image/png",".jpg":"image/jpeg",".jpeg":"image/jpeg",".webp":"image/webp",".gif":"image/gif"}[r]||"image/png"}const Fe=5,tr=32*1024*1024;let V=null;function we(){try{const e=JSON.parse(u.readFileSync(ze(),"utf8"));return ye(e)}catch{return[]}}function rr(e){const r=ye(e),t=[...we()];for(const o of r){const a=t.findIndex(s=>s.id===o.id);a>=0?t[a]=o:t.push(o)}const n=t.slice(0,Fe);return Je(n),n}function nr(e,r,t,n=4){const o=Ke()[e]??{};return[...r].sort((a,s)=>{if(a===t)return-1;if(s===t)return 1;const c=o[a]??{count:0,lastUsedAt:0},i=o[s]??{count:0,lastUsedAt:0};return i.lastUsedAt-c.lastUsedAt||i.count-c.count}).slice(0,n)}function ue(e,r){if(!/^[a-z0-9-]+$/i.test(e)||!/^[a-z0-9-]+$/i.test(r))return;const t=Ke(),n=t[e]??{},o=n[r]??{count:0};n[r]={count:o.count+1,lastUsedAt:Date.now()},t[e]=n,Ge(qe(),t)}function or(){return V||(V=new Promise((e,r)=>{const t=ge.randomBytes(24).toString("hex"),n=je.createServer((o,a)=>{if(a.setHeader("Access-Control-Allow-Origin","*"),a.setHeader("Access-Control-Allow-Headers","Authorization, Content-Type"),a.setHeader("Access-Control-Allow-Methods","GET, PUT, POST, OPTIONS"),a.setHeader("Access-Control-Allow-Private-Network","true"),o.method==="OPTIONS"){a.writeHead(204).end();return}if(o.headers.authorization!==`Bearer ${t}`){a.writeHead(401).end("Unauthorized");return}if(o.url==="/theme-usage"&&o.method==="POST"){Ie(o,a,s=>{if(typeof(s==null?void 0:s.appId)!="string"||typeof(s==null?void 0:s.themeId)!="string")throw new Error("Invalid theme usage payload");ue(s.appId,s.themeId),ce(a,200,{success:!0})});return}if(o.url!=="/custom-themes"){a.writeHead(404).end("Not found");return}if(o.method==="GET"){ce(a,200,we());return}if(o.method!=="PUT"){a.writeHead(405).end("Method not allowed");return}Ie(o,a,s=>{const c=ye(s);Je(c),ce(a,200,c)})});n.once("error",r),n.listen(0,"127.0.0.1",()=>{const o=n.address();if(!o||typeof o=="string"){n.close(),r(new Error("Shared custom theme service did not expose a TCP port"));return}const a=`http://127.0.0.1:${o.port}`;e({endpoint:`${a}/custom-themes`,usageEndpoint:`${a}/theme-usage`,token:t})})}),V)}function ze(){return d.join(y.app.getPath("userData"),"custom-themes.json")}function qe(){return d.join(y.app.getPath("userData"),"theme-usage.json")}function Je(e){Ge(ze(),e)}function Ke(){try{const e=JSON.parse(u.readFileSync(qe(),"utf8"));return e&&typeof e=="object"&&!Array.isArray(e)?e:{}}catch{return{}}}function Ge(e,r){u.mkdirSync(d.dirname(e),{recursive:!0}),u.writeFileSync(e,`${JSON.stringify(r,null,2)}
`)}function Ie(e,r,t){let n=0;const o=[];e.on("data",a=>{if(n+=a.length,n>tr){r.writeHead(413).end("Payload too large"),e.destroy();return}o.push(a)}),e.on("end",()=>{if(!r.headersSent)try{t(JSON.parse(Buffer.concat(o).toString("utf8")))}catch(a){r.writeHead(400).end(a.message)}})}function ye(e){if(!Array.isArray(e))throw new Error("Custom themes must be an array");return e.slice(0,Fe).map((r,t)=>{var a,s;if(!r||typeof r!="object")throw new Error(`Invalid custom theme at index ${t}`);const n=r;if(typeof n.id!="string"||!/^custom-[a-z0-9-]+$/i.test(n.id))throw new Error(`Invalid custom theme id at index ${t}`);if(typeof n.name!="string"||!n.name.trim())throw new Error(`Invalid custom theme name at index ${t}`);if(typeof n.dataUrl!="string"||!/^data:image\/(?:png|jpeg|webp);base64,[A-Za-z0-9+/=]+$/.test(n.dataUrl))throw new Error(`Invalid custom theme image at index ${t}`);for(const c of["accent","secondary","surface","text"])if(typeof((a=n.colors)==null?void 0:a[c])!="string"||!/^#[0-9a-fA-F]{6}$/.test(n.colors[c]))throw new Error(`Invalid custom theme color ${c} at index ${t}`);const o=typeof((s=n.colors)==null?void 0:s.average)=="string"&&/^#[0-9a-fA-F]{6}$/.test(n.colors.average)?n.colors.average:void 0;return{id:n.id,name:n.name.trim(),dataUrl:n.dataUrl,colors:{accent:n.colors.accent,secondary:n.colors.secondary,surface:n.colors.surface,text:n.colors.text,...o?{average:o}:{}}}})}function ce(e,r,t){e.writeHead(r,{"Content-Type":"application/json; charset=utf-8"}),e.end(JSON.stringify(t))}function Y(e){const r=/^#([0-9a-f]{6})$/i.exec(e);if(!r)return[255,255,255];const t=parseInt(r[1],16);return[t>>16&255,t>>8&255,t&255]}function F(e){return"#"+e.map(r=>Math.max(0,Math.min(255,Math.round(r))).toString(16).padStart(2,"0")).join("")}function le(e){const r=e/255;return r<=.04045?r/12.92:Math.pow((r+.055)/1.055,2.4)}function ee(e){return .2126*le(e[0])+.7152*le(e[1])+.0722*le(e[2])}function N(e,r){const t=ee(e),n=ee(r);return(Math.max(t,n)+.05)/(Math.min(t,n)+.05)}function L(e,r,t){return[0,1,2].map(n=>e[n]+(r[n]-e[n])*t)}function Ve(e){const r=e[0]/255,t=e[1]/255,n=e[2]/255,o=Math.max(r,t,n),a=Math.min(r,t,n),s=(o+a)/2;if(o===a)return[0,0,s];const c=o-a,i=s>.5?c/(2-o-a):c/(o+a);let l;return o===r?l=(t-n)/c+(t<n?6:0):o===t?l=(n-r)/c+2:l=(r-t)/c+4,[l/6,i,s]}function pe(e,r,t){if(r<=0){const s=t*255;return[s,s,s]}const n=(s,c,i)=>(i<0&&(i+=1),i>1&&(i-=1),i<1/6?s+(c-s)*6*i:i<1/2?c:i<2/3?s+(c-s)*(2/3-i)*6:s),o=t<.5?t*(1+r):t+r-t*r,a=2*t-o;return[n(a,o,e+1/3)*255,n(a,o,e)*255,n(a,o,e-1/3)*255]}function ar(e,r,t){if(N(e,r)>=t)return e;const n=t+Math.max(.02,t*.02),o=ee(e),a=ee(r),s=o<a||o===a&&a>.475,[c,i,l]=Ve(e);if(i>=.02){let f=s?0:l,b=s?l:1;for(let C=0;C<14;C++){const A=(f+b)/2;N(pe(c,i,A),r)>=n?s?f=A:b=A:s?b=A:f=A}const v=pe(c,i,s?f:b);if(N(v,r)>=t)return v}const p=s?[0,0,0]:[255,255,255];let m=0,h=1;for(let f=0;f<12;f++){const b=(m+h)/2;N(L(e,p,b),r)>=n?h=b:m=b}return L(e,p,h)}function X(e,r,t){if(r.length===0)return e;const n=p=>Math.min(...r.map(m=>N(p,m)));let o=e;for(let p=0;p<4;p++){if(n(o)>=t)return o;const m=n(o);let h=r[0],f=1/0;for(const v of r){const C=N(o,v);C<f&&(f=C,h=v)}const b=ar(o,h,t);if(n(b)<=m+1e-9)break;o=b}if(n(o)>=t)return o;const[a,s]=Ve(e),c=[e,o];for(const p of[.02,.06,.12,.22,.78,.88,.95,.99])c.push(pe(a,s,p));let i=o,l=n(o);for(const p of c){const m=n(p);m>l+1e-9&&(l=m,i=p)}return i}function sr(e){if(e.length<16||e.readUInt32BE(0)!==2303741511)return null;let r=8,t=-1;const n=[];for(;r+12<=e.length;){const a=e.readUInt32BE(r),s=e.toString("ascii",r+4,r+8),c=e.subarray(r+8,r+8+a);if(s==="IHDR"){const i=c.readUInt32BE(0),l=c.readUInt32BE(4),p=c[8],m=c[12];if(i!==1||l!==1||p!==8||m!==0)return null;t=c[9]}else if(s==="IDAT")n.push(c);else if(s==="IEND")break;r+=12+a}if(t<0||n.length===0)return null;let o;try{o=ht.inflateSync(Buffer.concat(n))}catch{return null}if(o.length<2||o[0]>4)return null;switch(t){case 6:return o.length>=5?[o[1],o[2],o[3]]:null;case 2:return o.length>=4?[o[1],o[2],o[3]]:null;case 4:return o.length>=3?[o[1],o[1],o[1]]:null;case 0:return o.length>=2?[o[1],o[1],o[1]]:null;default:return null}}const D="dream-work-style",I="dream-work-menu",H=new Map,q=new Map,O=new Map,x={id:"wb-dream-sentinel-id",hero:"data:image/png;base64,WBDREAMHEROSENTINEL",accent:"#010203",secondary:"#040506",surface:"#070809",text:"#0a0b0c",textSubtle:"#0d0e0f",textSubtlest:"#101112",textSecondary:"#131415"},ir={zcode:[.7,.76,.88,.9],codex:[.76,.82,.86,.9,.92],catpaw:[.78,.82],"qoder-work":[.7,.82,.86,.9],"qwen-office":[.86,.9],workbuddy:[.58,.62,.92],"hana-agent":[.62,.66,.78]},Xe=[.7,.76,.88,.9];function Ze(e){return ir[e]??Xe}const Me=new Map;function cr(e){let r;try{r=u.statSync(e)}catch{return null}const t=Me.get(e);if(t&&t.size===r.size&&t.mtimeMs===r.mtimeMs)return t.rgb;let n=null;try{const o=y.nativeImage.createFromPath(e);if(!o.isEmpty()){const a=o.resize({width:1,height:1}).toDataURL();n=sr(Buffer.from(a.slice(a.indexOf(",")+1),"base64"))}}catch(o){console.warn("[injector] Hero average sampling failed:",o.message)}return Me.set(e,{size:r.size,mtimeMs:r.mtimeMs,rgb:n}),n}let Z=null;async function lr(){if(!Z)try{const e=d.resolve(__dirname,"manager","codex-dream-skin.css");Z=await ut.readFile(e,"utf-8")}catch(e){console.warn("[injector] Failed to load Codex base CSS:",e.message),Z=""}return Z}async function Qe(e,r,t,n={}){const o=M(e),a=n.rendererUrlHint?[n.rendererUrlHint]:(o==null?void 0:o.rendererHints)??["renderer/index.html","index.html"];let s=[],c="No renderer targets found";for(const i of a)try{if(console.log(`[injector] Trying hint "${i}" on port ${t}`),s=await zt(t,i,{timeoutMs:2e4,pollMs:500}),s.length>0){console.log(`[injector] Found ${s.length} targets with hint "${i}"`);break}}catch(l){c=l.message,console.log(`[injector] Hint "${i}" failed: ${l.message}`)}if(s.length===0)try{console.log(`[injector] Strict hints failed, trying relaxed page-target fallback on port ${t}`);const l=await(await fetch(`http://127.0.0.1:${t}/json/list`,{signal:AbortSignal.timeout(5e3)})).json(),p=(Array.isArray(l)?l:[]).filter(xe).sort((m,h)=>{const f=[String(m.id??""),m.url,m.webSocketDebuggerUrl],b=[String(h.id??""),h.url,h.webSocketDebuggerUrl];for(let v=0;v<f.length;v++){if(f[v]<b[v])return-1;if(f[v]>b[v])return 1}return 0});p.length>0&&(console.log(`[injector] Relaxed fallback found ${p.length} page targets`),s=p)}catch(i){console.log(`[injector] Relaxed fallback failed: ${i.message}`)}if(s.length===0)return{success:!1,applied:0,error:c};try{const i=oe(e);if(console.log(`[injector] Loaded ${i.length} themes`),!i.some(g=>g.id===r))return{success:!1,applied:0,error:`Theme ${r} is not compatible with ${e}`};const l=nr(e,i.map(g=>g.id),r,8),p=new Map(i.map(g=>[g.id,g])),m=l.map(g=>p.get(g)).filter(Boolean),h=new Map;for(const g of m)h.set(g.id,{name:g.name,css:Ae(e,g.manifest,Zt(g),cr(d.join(g.path,g.manifest.hero))),surface:g.manifest.colors.surface});const f=Array.from(h.entries()).map(([g,k])=>{var P;return{id:g,name:k.name,css:k.css,surface:k.surface,accent:((P=i.find(w=>w.id===g))==null?void 0:P.manifest.colors.accent)??"#24c9d7"}});let b=we();if(b.length===0){const g=e==="workbuddy"?"dreamCustomThemes":"dreamCodexCustomThemes";for(const k of s){const P=new U(k.webSocketDebuggerUrl);try{await P.open();const w=await P.evaluate(`(() => localStorage.getItem(${JSON.stringify(g)}) || '[]')()`),$=JSON.parse(w);if(Array.isArray($)&&$.length>0){b=rr($);break}}catch(w){console.warn(`[injector] Failed to import existing custom themes from ${e} target ${k.id}:`,w)}finally{P.close()}}}const v=await or(),C=e==="workbuddy"?Tr({styleId:D,menuId:I,currentThemeId:r,themes:f,sharedCustomThemes:b,sharedCustomThemeService:v,cssTemplate:et({id:x.id,colors:{accent:x.accent,secondary:x.secondary,surface:x.surface,text:x.text},copy:null},x.hero,{accent:x.accent,secondary:x.secondary,surface:x.surface,text:x.text})}):e==="hana-agent"?kr({styleId:D,menuId:I,currentThemeId:r,themes:f,sharedCustomThemes:b,sharedCustomThemeService:v,cssTemplate:Ye({id:x.id,colors:{accent:x.accent,secondary:x.secondary,surface:x.surface,text:x.text}},x.hero,{accent:x.accent,secondary:x.secondary,surface:x.surface,text:x.text})}):Er({styleId:D,menuId:I,currentThemeId:r,appId:e,themes:f,sharedCustomThemes:b,sharedCustomThemeService:v,cssTemplate:Ae(e,{id:x.id,colors:{accent:x.accent,secondary:x.secondary,surface:x.surface,text:x.text}},x.hero,null,{template:!0}),surfaceAlphas:Ze(e)});let A=0;for(const g of s)try{console.log(`[injector] Injecting to target ${g.id}: ${g.url}`);const k=new U(g.webSocketDebuggerUrl);if(await k.open(),e==="workbuddy"&&!await k.evaluate(`(() => {
          ...
          })()`)){console.warn(`[injector] Skipping non-WorkBuddy target ${g.id}: ${g.url}`),k.close();continue}if(e==="codex"){const w=await lr();w&&await k.evaluate(`(() => {
          ...
          })()`,$=H.get(g.id);$&&await k.removeScriptToEvaluateOnNewDocument($).catch(()=>{});const T=await k.addScriptToEvaluateOnNewDocument(w);T&&H.set(g.id,T)}const P=await k.evaluate(e==="hana-agent"?`(() => { window.__dreamWorkForceApply = true; return ${C}; })()`:C);if(console.log(`[injector] Injection result for target ${g.id}:`,P),e==="hana-agent"){let w=!1;for(let $=0;$<20&&(w=await k.evaluate(`(() => {
            ...
            })()`);console.log(`[injector] Codex debug info for ${g.id}:`,JSON.stringify(w,null,2))}catch(w){console.error(`[injector] Failed to get debug info for ${g.id}:`,w)}k.close(),A++}catch(k){console.error(`[injector] Failed to inject to target ${g.id}:`,k)}if(e==="hana-agent"&&A>0){const g=new Set(s.map($=>$.id)),k=Date.now()+2e4;let P="",w=0;for(;Date.now()<k;){let $=[];try{$=await G(t,".hanako/artifacts/renderer/",{timeoutMs:2e3,quiet:!0})}catch{}const T=$[0];if(!T){P="",w=0,await new Promise(j=>setTimeout(j,250));continue}if(!g.has(T.id)){console.log(`[injector] HanaAgent created renderer target ${T.id}; injecting theme`);const j=new U(T.webSocketDebuggerUrl);try{await j.open();const ot=`(() => {
              const inject = () => ${C};
              if (document.readyState === 'loading') window.addEventListener('DOMContentLoaded', inject, { once: true });
              else inject();
            })()`,Ce=await j.addScriptToEvaluateOnNewDocument(ot);Ce&&H.set(T.id,Ce),await j.evaluate(`(() => { window.__dreamWorkForceApply = true; return ${C}; })()`),g.add(T.id)}finally{j.close()}}const ae=new U(T.webSocketDebuggerUrl);let ve=!1;try{await ae.open(),ve=await ae.evaluate(`(() => {
            const host = document.getElementById('${I}-host');
            return Boolean(document.getElementById('${D}') && host?.shadowRoot?.getElementById('${I}') && document.documentElement.dataset.dreamTheme);
          })()`)}catch{}finally{ae.close()}if(ve){if(P!==T.id)P=T.id,w=Date.now();else if(Date.now()-w>=2e3)return mr(t,C,g),ue(e,r),{success:!0,applied:1}}else P="",w=0;await new Promise(j=>setTimeout(j,250))}return{success:!1,applied:0,error:"HanaAgent renderer did not stabilize with the injected theme"}}return A>0&&ue(e,r),{success:A>0,applied:A}}catch(i){return console.error("[injector] Injection failed:",i),{success:!1,applied:0,error:i.message}}}async function dr(e,r,t={}){return pr(e,r,t)}function mr(e,r,t){const n=q.get(e);n&&clearInterval(n);const o=(O.get(e)??0)+1;O.set(e,o);let a=!1;const s=setInterval(async()=>{if(!a&&O.get(e)===o){a=!0;try{const i=(await G(e,".hanako/artifacts/renderer/",{timeoutMs:1e3,quiet:!0}))[0];if(!i||O.get(e)!==o)return;const l=new U(i.webSocketDebuggerUrl);try{await l.open();const p=await l.evaluate(`(() => {
          const host = document.getElementById('${I}-host');
        ...
        })()`;if(!t.has(i.id)){const h=await l.addScriptToEvaluateOnNewDocument(m);h&&H.set(i.id,h)}if(await l.evaluate(r),O.get(e)!==o){await l.evaluate(`(() => {
          ...
          })()`).catch(()=>{});return}t.add(i.id)}finally{l.close()}}catch{await ur(e)||(clearInterval(s),q.delete(e))}finally{a=!1}}},1e3);q.set(e,s)}async function ur(e){try{return(await fetch(`http://127.0.0.1:${e}/json/version`,{signal:AbortSignal.timeout(500)})).ok}catch{return!1}}async function pr(e,r,t={}){var c;const n=t.rendererUrlHint?[t.rendererUrlHint]:((c=M(e))==null?void 0:c.rendererHints)??["renderer/index.html","index.html"];let o=[];for(const i of n)try{if(o=await G(r,i,{timeoutMs:1e3,quiet:!0}),o.length>0)break}catch{}if(o.length===0)try{const l=await(await fetch(`http://127.0.0.1:${r}/json/list`,{signal:AbortSignal.timeout(5e3)})).json();o=(Array.isArray(l)?l:[]).filter(xe).sort((p,m)=>{const h=[String(p.id??""),p.url,p.webSocketDebuggerUrl],f=[String(m.id??""),m.url,m.webSocketDebuggerUrl];for(let b=0;b<h.length;b++){if(h[b]<f[b])return-1;if(h[b]>f[b])return 1}return 0})}catch{}if(o.length===0)return{installed:!1,menu:!1,targets:0};const a=[];for(const i of o){const l=new U(i.webSocketDebuggerUrl);try{if(await l.open(),e==="workbuddy"&&!await l.evaluate("(() => document.body?.dataset.applicationName === 'workbuddy')()"))continue;const p=await l.evaluate(`(() => {
      ...
      })()`),m=JSON.parse(p);a.push(m)}catch(p){console.warn(`[injector] Status check failed for ${e} target ${i.id}:`,p)}finally{l.close()}}const s=a.find(i=>i.installed&&i.themeId)??a.find(i=>i.installed);return{installed:a.some(i=>i.installed),menu:a.some(i=>i.menu),themeId:s==null?void 0:s.themeId,targets:a.length}}async function hr(e,r,t={}){var a;if(e==="hana-agent"){O.set(r,(O.get(r)??0)+1);const s=q.get(r);s&&clearInterval(s),q.delete(r)}const n=t.rendererUrlHint??((a=M(e))==null?void 0:a.rendererHints[0])??"renderer/index.html";let o=[];try{o=await G(r,n)}catch{}if(o.length===0)try{const c=await(await fetch(`http://127.0.0.1:${r}/json/list`,{signal:AbortSignal.timeout(5e3)})).json();o=(Array.isArray(c)?c:[]).filter(xe).sort((i,l)=>{const p=[String(i.id??""),i.url,i.webSocketDebuggerUrl],m=[String(l.id??""),l.url,l.webSocketDebuggerUrl];for(let h=0;h<p.length;h++){if(p[h]<m[h])return-1;if(p[h]>m[h])return 1}return 0})}catch{}if(o.length===0)return{success:!1};for(const s of e==="hana-agent"?o:o.slice(0,1)){const c=new U(s.webSocketDebuggerUrl);if(await c.open(),e==="hana-agent"){const i=H.get(s.id);i&&(await c.removeScriptToEvaluateOnNewDocument(i).catch(()=>{}),H.delete(s.id))}await c.evaluate(`(() => {
      ...
      return true;
    })`),c.close()}return{success:!0}}function gr(e,r,t,n){const o=Y(e),a=n.map(c=>L(t??o,o,c)),s=X(Y(r),a,4.5);return{text:F(s),textSubtle:F(X(L(o,s,.88),a,3)),textSubtlest:F(X(L(o,s,.8),a,3)),textSecondary:F(X(L(o,s,.72),a,3))}}function fr(e){const r=e[0]/255,t=e[1]/255,n=e[2]/255,o=Math.max(r,t,n),a=Math.min(r,t,n),s=(o+a)/2,c=o-a,i=c===0?0:c/(1-Math.abs(2*s-1)),m=(((c===0?0:o===r?(t-n)/c%6:o===t?(n-r)/c+2:(r-t)/c+4)*60%360+360)%360-60+360)%360,h=(1-Math.abs(2*s-1))*Math.max(i,.35),f=h*(1-Math.abs(m/60%2-1)),b=s-h/2;return(m<60?[h,f,0]:m<120?[f,h,0]:m<180?[0,h,f]:m<240?[0,f,h]:m<300?[f,0,h]:[h,0,f]).map(C=>(C+b)*255)}function Pe(e){let r;try{r=Y(e)}catch{return null}const t=r[0]/255,n=r[1]/255,o=r[2]/255,a=Math.max(t,n,o),s=Math.min(t,n,o),c=a-s;let i=0;return c>0&&(i=((a===t?(n-o)/c%6:a===n?(o-t)/c+2:(t-n)/c+4)*60%360+360)%360),{h:i,chroma:c}}function br(e,r){const t=Pe(e),n=Pe(r);if(!t||!n)return r;const o=Math.abs(t.h-n.h)%360;return(o>180?360-o:o)>=45&&n.chroma>=.1?r:F(fr(Y(e)))}function Ae(e,r,t,n=null,o={}){var p,m,h,f;const a=((p=r.colors)==null?void 0:p.surface)??"#f7fbff",s=((m=r.colors)==null?void 0:m.text)??"#17344f",c=o.template?{text:s,textSubtle:x.textSubtle,textSubtlest:x.textSubtlest,textSecondary:x.textSecondary}:gr(a,s,n,Ze(e)),i={accent:((h=r.colors)==null?void 0:h.accent)??"#24c9d7",secondary:((f=r.colors)==null?void 0:f.secondary)??"#ef8fd3",surface:a,...c};if(e==="zcode"&&!o.template&&(i.secondary=br(i.accent,i.secondary)),e==="codex")return $r(r,t,i);const l=M(e);return(l==null?void 0:l.kind)==="vscode-work"?xr(r,t,i):(l==null?void 0:l.kind)==="generic-work"?e==="hana-agent"?Ye(r,t,i):wr(e,r,t,i):et({...r,copy:null},t,i)}function xr(e,r,t){return`/* DREAM_THEME:${e.id} */
:root {
...
#root::after {
  ...
  pointer-events: none;
}`}function $r(e,r,t){const n=Sr(t.surface),o=n?`color-mix(in srgb, ${t.surface} 90%, transparent)`:`color-mix(in srgb, ${t.surface} 86%, transparent)`,a=n?`color-mix(in srgb, ${t.accent} 16%, ${t.surface})`:`color-mix(in srgb, ${t.accent} 42%, ${t.surface})`,s=n?"#172033":`color-mix(in srgb, ${t.surface} 72%, #000000)`,c="#f2f6ff",i=`/* DREAM_THEME:${e.id} */
...
`+l}function Sr(e){const r=/^#([0-9a-f]{6})$/i.exec(e);if(!r)return!0;const t=parseInt(r[1],16);return .299*(t>>16&255)+.587*(t>>8&255)+.114*(t&255)>140}function Tr(e){return`(() => {
  ...
  return true;
})()`}function Er(e){const r=JSON.stringify(e.themes),t=JSON.stringify(e.cssTemplate??""),n=e.appId,o=e.surfaceAlphas??Xe;return`(() => {
  const themes = ${r};
  const cssTemplate = ${t};
  const sentinels = ${JSON.stringify(x)};
  ...
  ensureInjectedNodes();
})()`}function Ir(e){if(!/^[a-z0-9._-]+$/i.test(e.id||""))throw new Error(`Invalid shortcut id: ${e.id}`);if(!/^[a-z0-9-]+$/i.test(e.appId||""))throw new Error(`Invalid appId: ${e.appId}`);if(!/^[a-z0-9._-]+$/i.test(e.themeId||""))throw new Error(`Invalid themeId: ${e.themeId}`)}function ke(e){const r=e.replace(/[^\p{L}\p{N} ._-]/gu,"").trim();return r.length>0?r.slice(0,80):"DreamWorkTheme"}async function Mr(e){try{return Ir(e),E.platform()==="win32"?Pr(e):E.platform()==="darwin"?Ar(e):E.platform()==="linux"?_r(e):{success:!1,error:`Unsupported platform: ${E.platform()}`}}catch(r){return{success:!1,error:r.message}}}function Pr(e){const r=d.join(E.homedir(),"Desktop"),t=d.join(r,`${ke(e.label)}.lnk`),n=process.execPath,o=d.dirname(n),a=`
    ...
    $Shortcut.Save()
  `;return new Promise(s=>{require("child_process").execFile("powershell.exe",["-NoProfile","-Command",a],c=>{s(c?{success:!1,error:c.message}:{success:!0,path:t})})})}function Ar(e){const r=d.join(E.homedir(),"Desktop"),t=d.join(r,`${ke(e.label)}.app`),o=`
    tell application "Terminal"
      do script "'${process.execPath}' --launch=${e.appId}:${e.themeId}"
    end tell
  `,a=d.join(r,`${e.id}.scpt`);return u.writeFileSync(a,o),new Promise(s=>{require("child_process").execFile("osacompile",["-o",t,a],c=>{u.unlinkSync(a),s(c?{success:!1,error:c.message}:{success:!0,path:t})})})}async function _r(e){const r=d.join(E.homedir(),".local","share","applications");u.existsSync(r)||u.mkdirSync(r,{recursive:!0});const t=d.join(r,`${e.id}.desktop`),n=process.execPath,o=`[Desktop Entry]
Type=Application
Name=${ke(e.label)}
...
Terminal=false
Categories=Utility;
`;return u.writeFileSync(t,o),u.chmodSync(t,493),{success:!0,path:t}}const Dr=he.promisify(re.execFile),jr="https://api.dreamskin.cc",tt=`${jr}/v1/themes`,rt=32*1024*1024,te=6;let de=0;const Rr=["workbuddy","codex","trae-work","qoder-work","catpaw","zcode","qwen-office","hana-agent"];async function Or(){const e=de,r=await Ur(e),t=r.items;de=e+t.length>=r.total?0:e+te;const n=He(),o={checked:t.length,imported:0,skipped:0,offset:e,page:Math.floor(e/te)+1,total:r.total,nextOffset:de,failed:[]};for(const a of t){const s=Wr(a.themeId);if(!a.applyCompatible||We(s)){o.skipped++;continue}try{await Nr(a,n,s)?o.imported++:o.skipped++}catch(c){o.failed.push({id:a.id,name:a.name,error:c.message})}}return o}async function Ur(e){const r=`${tt}?limit=${te}&offset=${e}&sort=recent`,t=await fetch(r,{signal:AbortSignal.timeout(3e4),redirect:"error"});if(!t.ok)throw new Error(`Theme list request failed: HTTP ${t.status}`);const n=await t.json();if(!Array.isArray(n.items)||n.items.length>te||!Number.isInteger(n.total)||n.total<0)throw new Error("Theme list response is invalid");return{items:n.items,total:n.total}}async function Nr(e,r,t){Hr(e);const n=u.mkdtempSync(d.join(E.tmpdir(),"dream-work-theme-")),o=d.join(n,"theme.zip"),a=d.join(n,"extract"),s=d.join(r,`.updating-${t}-${process.pid}`);try{u.mkdirSync(a);const c=`${tt}/${e.id}/download`,i=await fetch(c,{signal:AbortSignal.timeout(12e4),redirect:"error"});if(!i.ok)throw new Error(`Theme download failed: HTTP ${i.status}`);const l=Buffer.from(await i.arrayBuffer());if(l.length!==e.packageBytes)throw new Error(`Downloaded size mismatch: expected ${e.packageBytes}, got ${l.length}`);if(l.length>rt)throw new Error("Theme package exceeds 32 MiB");if(ge.createHash("sha256").update(l).digest("hex")!==e.packageSha256)throw new Error("Downloaded SHA-256 does not match metadata");u.writeFileSync(o,l,{flag:"wx"}),await Lr(o,a);const m=Br(a),h=JSON.parse(u.readFileSync(d.join(m,"theme.json"),"utf8")),f=h.image;if(typeof f!="string"||d.basename(f)!==f||!/\.(png|jpe?g|webp)$/i.test(f))throw new Error("Theme image name is invalid");const b=d.join(m,f),v=d.join(m,"theme.css");if(!u.existsSync(b)||!u.statSync(b).isFile())throw new Error("Theme image is missing");if(!u.existsSync(v)||!u.statSync(v).isFile())throw new Error("theme.css is missing");const C=Fr(h,e,t,`hero${d.extname(f).toLowerCase()}`);return Qt(C.name,C.author,b)?!1:(u.mkdirSync(s),u.copyFileSync(b,d.join(s,C.hero)),u.copyFileSync(v,d.join(s,"theme.css")),u.writeFileSync(d.join(s,"theme.json"),`${JSON.stringify(C,null,2)}
`),u.renameSync(s,d.join(r,t)),!0)}finally{u.rmSync(s,{recursive:!0,force:!0}),u.rmSync(n,{recursive:!0,force:!0})}}async function Lr(e,r){const{path7za:t}=require("7zip-bin");await Dr(t,["x",e,`-o${r}`,"-y"],{windowsHide:!0,timeout:12e4})}function Br(e){const t=[e,...u.readdirSync(e,{withFileTypes:!0}).filter(n=>n.isDirectory()).map(n=>d.join(e,n.name))].filter(n=>u.existsSync(d.join(n,"theme.json"))&&u.existsSync(d.join(n,"theme.css")));if(t.length!==1)throw new Error("Theme ZIP must contain one theme root");return t[0]}function Hr(e){if(!/^ver_[a-z0-9]{8,64}$/.test(e.id))throw new Error("Theme version ID is invalid");if(!Number.isInteger(e.packageBytes)||e.packageBytes<1||e.packageBytes>rt)throw new Error("Theme package size is invalid");if(!/^[a-f0-9]{64}$/.test(e.packageSha256))throw new Error("Theme package SHA-256 is invalid")}function Wr(e){return String(e).toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"").replace(/-+/g,"-")||"community-theme"}function Fr(e,r,t,n){const o=e.appearance==="dark"?"dark":"light",a=o==="dark"?"#10141c":"#f4f7fa",s=e.colors||{};return{schemaVersion:1,id:t,name:String(e.name||r.name||t).trim(),author:r.authorDisplayName||"DreamSkin Community",hero:n,colors:{accent:z(s.accent,"#4f8cff",a),secondary:z(s.secondary||s.accentAlt,"#7ba7d8",a),surface:z(s.panelAlt||s.panel||s.background,a,a),text:z(s.text,o==="dark"?"#eef2f7":"#1f2937",a)},copy:null,apps:Object.fromEntries(Rr.map(c=>[c,{compat:!0}]))}}function z(e,r,t){if(typeof e!="string")return r;const n=e.trim().match(/^#([0-9a-f]{3}|[0-9a-f]{6}|[0-9a-f]{8})$/i);if(n){let i=n[1];return i.length===3&&(i=i.split("").map(l=>l+l).join("")),`#${i.slice(0,6).toLowerCase()}`}const o=e.trim().match(/^rgba?\(\s*(\d{1,3})\s*,\s*(\d{1,3})\s*,\s*(\d{1,3})(?:\s*,\s*(0|1|0?\.\d+))?\s*\)$/i);if(!o)return r;const a=o[4]===void 0?1:Number(o[4]),s=z(t,r,r).slice(1).match(/../g).map(i=>parseInt(i,16));return`#${[1,2,3].map(i=>Math.round(Number(o[i])*a+s[i-1]*(1-a))).map(i=>i.toString(16).padStart(2,"0")).join("")}`}let J=null;y.protocol.registerSchemesAsPrivileged([{scheme:"theme-asset",privileges:{standard:!0,secure:!0,supportFetchAPI:!0,stream:!0}}]);function nt(){J=new y.BrowserWindow({width:1200,height:800,webPreferences:{preload:d.join(__dirname,"preload.js"),contextIsolation:!0,nodeIntegration:!1}}),process.env.VITE_DEV_SERVER_URL?J.loadURL(process.env.VITE_DEV_SERVER_URL):J.loadFile(d.join(__dirname,"../renderer/dist/index.html"))}y.app.whenReady().then(()=>{y.protocol.handle("theme-asset",e=>{const r=decodeURIComponent(new URL(e.url).pathname.replace(/^\//,"")),t=Vt(r);return t?new Response(u.readFileSync(t),{headers:{"Content-Type":zr(t),"Cache-Control":"public, max-age=3600"}}):new Response("Theme asset not found",{status:404})}),nt()});function zr(e){const r=d.extname(e).toLowerCase();return r===".jpg"||r===".jpeg"?"image/jpeg":r===".webp"?"image/webp":"image/png"}y.app.on("window-all-closed",()=>{process.platform!=="darwin"&&y.app.quit()});y.app.on("activate",()=>{y.BrowserWindow.getAllWindows().length===0&&nt()});const De=process.argv.find(e=>e.startsWith("--launch="));if(De){const[,e]=De.split("="),[r,t]=e.split(":");r&&t&&(console.log(`[main] Received launch args: ${r}:${t}`),setTimeout(async()=>{try{const n=await Le(r,t);n.success?(console.log(`[main] Launched ${r} with theme ${t} on port ${n.port}`),setTimeout(async()=>{try{console.log(`[main] Starting theme injection for ${r}:${t} on port ${n.port}`);const o=await Qe(r,t,n.port);console.log("[main] Injection result:",o)}catch(o){console.error("[main] Failed to inject theme:",o)}},3e3)):console.error(`[main] Failed to launch ${r}: ${n.error}`)}catch(n){console.error("[main] Launch error:",n)}},1e3))}y.ipcMain.handle("discover-apps",async()=>St());y.ipcMain.handle("list-app-path-configurations",()=>gt());y.ipcMain.handle("choose-custom-app-path",async(e,r)=>{if(process.platform!=="win32")return{success:!1,error:"自定义应用路径目前仅支持 Windows。"};const t=M(r);if(!t)return{success:!1,error:`Unknown app: ${r}`};const n={title:`选择 ${t.name} 的可执行文件`,buttonLabel:"选择此文件",properties:["openFile"],filters:[{name:`${t.name} 可执行文件`,extensions:["exe"]}]},o=J?await y.dialog.showOpenDialog(J,n):await y.dialog.showOpenDialog(n);if(o.canceled||o.filePaths.length===0)return{success:!1,cancelled:!0};try{return{success:!0,path:bt(r,o.filePaths[0])}}catch(a){return{success:!1,error:(a==null?void 0:a.message)||String(a)}}});y.ipcMain.handle("clear-custom-app-path",(e,r)=>{try{return xt(r),{success:!0}}catch(t){return{success:!1,error:(t==null?void 0:t.message)||String(t)}}});y.ipcMain.handle("launch-app",async(e,r,t)=>Le(r,t));y.ipcMain.handle("apply-theme",async(e,r,t,n)=>Qe(r,t,n));y.ipcMain.handle("create-shortcut",async(e,r)=>{const t={...r,id:`${r.appId}-${r.themeId}-${Date.now()}`};return Mr(t)});y.ipcMain.handle("list-themes",async(e,r)=>oe(r).map(t=>({id:t.id,name:t.name,author:t.author,hero:Xt(t.id)})));y.ipcMain.handle("update-themes",async()=>Or());y.ipcMain.handle("get-status",async(e,r,t)=>{var o;return await Tt(r)?{...await dr(r,t||((o=M(r))==null?void 0:o.defaultPort)||9339),running:!0}:{installed:!1,menu:!1,targets:0,running:!1}});y.ipcMain.handle("remove-skin",async(e,r,t)=>hr(r,t));y.ipcMain.handle("debug-targets",async(e,r)=>{try{const n=await(await fetch(`http://127.0.0.1:${r}/json/list`,{signal:AbortSignal.timeout(5e3)})).json();return{success:!0,count:n.length,raw:n,targets:n.map(o=>({id:o.id,type:o.type,url:o.url,title:o.title,webSocketDebuggerUrl:o.webSocketDebuggerUrl}))}}catch(t){return{success:!1,error:t.message}}});
